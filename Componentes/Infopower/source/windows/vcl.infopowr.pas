...
ipabout, Wwdbgrid, wwdblook, wwidlg, Wwdbdlg, Wwprpedt, Wwkeycb, Wwdotdot, Wwdatsrc, Wwlocate, Wwdbcomb, Wwdbspin, wwdbedit,
wwfltdlg, Wwintl, wwprpds, Wwdbigrd, wwDataInspector, wwInspectorPrpEdt, wwriched, wwDBNavigator, wwDBNavEdt, wwmonthcalendar, wwdbdatetimepicker,
...
procedure Register;
begin
RegisterComponents('InfoPower Access', [ TwwDataSource ] );
