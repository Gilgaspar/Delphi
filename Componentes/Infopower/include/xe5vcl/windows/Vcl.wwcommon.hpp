...
// (DO NOT EDIT: machine generated header) 'vcl.Wwcommon.pas' rev: 26.00 (Windows)
...
#include <System.RegularExpressions.hpp>	// Pascal unit
...
extern DELPHI_PACKAGE System::Variant __fastcall wwGetVariableWithParams2(System::Classes::TComponent* Component, System::UnicodeString VariableName, System::TVarRec const *StartValues, const int StartValues_Size, System::TVarRec const *EndValues, const int EndValues_Size);
