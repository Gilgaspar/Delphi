...
// (DO NOT EDIT: machine generated header) 'vcl.wwbutton.pas' rev: 26.00 (Windows)
...
#include <vcl.Wwbitmap.hpp>	// Pascal unit
#include <vcl.wwchangelink.hpp>	// Pascal unit
...
#include <vcl.wwtext.hpp>	// Pascal unit
...
protected:
	...
	virtual void __fastcall Draw3dLines(Vcl::Wwbitmap::TwwBitmap* Bitmap, System::Types::TPoint *PointList, const int PointList_Size, int NumPoints, System::Uitypes::TColor TransColor, Vcl::Wwbitmap::TwwBitmap* PaintBitmap = (Vcl::Wwbitmap::TwwBitmap*)(0x0))/* overload */;
