...
// (DO NOT EDIT: machine generated header) 'ipstudiowindataset.pas' rev: 26.00 (Windows)

#ifndef IpstudiowindatasetHPP
#define IpstudiowindatasetHPP
...
namespace Ipstudiowindataset
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Ipstudiowindataset */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_IPSTUDIOWINDATASET)
using namespace Ipstudiowindataset;
#endif
#pragma pack(pop)
#pragma option pop
