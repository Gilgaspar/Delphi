...
// (DO NOT EDIT: machine generated header) 'dipstudiowin.pas' rev: 26.00 (Windows)
...
#include <vcl.wwdbnavedt.hpp>	// Pascal unit
#include <vcl.wwcollectioneditor.hpp>	// Pascal unit
#include <vcl.wwInspectorPrpEdt.hpp>	// Pascal unit
...
#include <vcl.wwmonthcalendar.hpp>	// Pascal unit
...
#include <vcl.wwcheckbox.hpp>	// Pascal unit
...
#include <vcl.wwbutton.hpp>	// Pascal unit
