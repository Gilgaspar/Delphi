...
// (DO NOT EDIT: machine generated header) 'vcl.wwdbdlg.pas' rev: 26.00 (Windows)
...
__published:
	...
	__property Vcl::Wwdbigrd::TwwDBGridOptions GridOptions = {read=FGridOptions, write=SetGridOptions, default=9469};
