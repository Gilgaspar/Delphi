...
// (DO NOT EDIT: machine generated header) 'vcl.Wwrcdvw.pas' rev: 26.00 (Windows)
...
#include <vcl.wwdatsrc.hpp>	// Pascal unit
...
#include <vcl.Wwmemo.hpp>	// Pascal unit
...
#include <vcl.wwradiogroup.hpp>	// Pascal unit
...
class PASCALIMPLEMENTATION TwwDBCheckBox : public Vcl::Dbctrls::TDBCheckBox
{
	typedef Vcl::Dbctrls::TDBCheckBox inherited;
...
public:
	/* TDBCheckBox.Create */ inline __fastcall virtual TwwDBCheckBox(System::Classes::TComponent* AOwner) : Vcl::Dbctrls::TDBCheckBox(AOwner) { }
	/* TDBCheckBox.Destroy */ inline __fastcall virtual ~TwwDBCheckBox(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TwwDBCheckBox(HWND ParentWindow) : Vcl::Dbctrls::TDBCheckBox(ParentWindow) { }
