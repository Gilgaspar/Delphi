...
// (DO NOT EDIT: machine generated header) 'ipstudiowinclient.pas' rev: 26.00 (Windows)
...
#include <vcl.wwmidas.hpp>	// Pascal unit
#include <vcl.wwclient.hpp>	// Pascal unit
#include <vcl.wwprovider.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_IPSTUDIOWINCLIENT)
