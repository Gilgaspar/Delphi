...
uses frxUtils, frxFileUtils, SyncObjs{$IFNDEF Linux}, ComObj{$ENDIF};
...
{$ENDIF}
          ...
          begin
              ...
              begin
                ...
                if (s = 'HTML') or (s = 'HTM') then FFormat := sfHTM else
                FFormat := sfHTMD;
              end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        FName := PathDelim + FSessionId + FRepSession.ResultPage;
      end;
