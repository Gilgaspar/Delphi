...
type
  TfrxFrameEditorForm = class(TfrxBaseForm)
    ...
    procedure LineWidthCBChange(Sender: TObject);
  private
    FFrame: TfrxFrame;
    ...
    procedure LineColorChanged(Sender: TObject);
    procedure LineStyleChanged(Sender: TObject);
...
begin
  ...
  LineStyleC.OnStyleChanged := LineStyleChanged;
  ...
  LineColorCB.OnColorChanged := LineColorChanged;
...
procedure TfrxFrameEditorForm.LineStyleChanged(Sender: TObject);
begin
  FFrame.Style := LineStyleC.Style;
  Change;
end;
...
procedure TfrxFrameEditorForm.LineWidthCBChange(Sender: TObject);
begin
  FFrame.Width := frxStrToFloat(LineWidthCB.Text);
  Change;
end;
...
procedure TfrxFrameEditorForm.LineColorChanged(Sender: TObject);
begin
  FFrame.Color := LineColorCB.Color;
  Change;
end;
