...
{$ENDIF}
  ...
  TfrxTreePanel = class(TfrxDPIAwarePanel)
  private
    ...
    procedure SetToolPanelAlign(const Value: TfrxToolAlign);
...
var
  ...
  begin
    ...
    begin
      ...
      if not bFound then
        bFound := (Pos(lFilter, UpperCase(nNext.FText)) > 0);
...
function TfrxTreePanel.CalcButtonsWidth: Integer;
begin
...
procedure TfrxTreePanel.DoPPIChanged(aNewPPI: Integer);
begin
  inherited;
...
function TfrxTreePanel.GetFilterColor: TColor;
begin
  Result := FFilter.FilterColor;
end;

function TfrxTreePanel.GetFilterVisible: Boolean;
begin
  Result := FPanel.Visible and FFilter.Visible;
end;

function TfrxTreePanel.GetImageList: TCustomImageList;
begin
  Result := nil;
...
function TfrxTreePanel.GetToolVisible: Boolean;
begin
  Result := False;
  if Assigned(FToolPanel) then
...
procedure TfrxTreePanel.Resize;
begin
  inherited Resize;
{$IFNDEF FPC}
  UpdateSize;
...
{$IFDEF FPC}
procedure TfrxTreePanel.DoOnResize;
begin
...
procedure TfrxTreePanel.SetFileterMaxWidth(const Value: Integer);
begin
  FFileterMaxWidth := Value;
  UpdateSize;
end;

procedure TfrxTreePanel.SetFileterMinWidth(const Value: Integer);
begin
  FFileterMinWidth := Value;
  UpdateSize;
end;

procedure TfrxTreePanel.SetFilterActiveImageIndex(const Value: Integer);
begin
...
procedure TfrxTreePanel.SetFilterAlign(const Value: TfrxFilterAlign);
begin
  FFilterAlign := Value;
  case Value of
...
procedure TfrxTreePanel.SetFilterColor(const Value: TColor);
begin
...
procedure TfrxTreePanel.SetFilterUnactiveImageIndex(const Value: Integer);
begin
...
procedure TfrxTreePanel.SetFilterVisible(const Value: Boolean);
begin
  FPanel.Visible := Value;
  FFilter.Visible := Value;
end;

procedure TfrxTreePanel.SetImageList(const Value: TCustomImageList);
begin
...
procedure TfrxTreePanel.SetToolVisible(const Value: Boolean);
begin
