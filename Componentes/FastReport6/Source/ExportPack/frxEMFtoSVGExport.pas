...
//    function MeasureTextLength: string;
  ...
  public
    ...
    procedure SetEmbedded(CSS: TfrxCSS; Obj: TfrxView);
...
begin
  ...
  Puts('<g fill="%s">', [GetColor(MonoBrushAverageColor(PLast^.FillRgn.ihBrush))]);
...
procedure TEMFtoSVGExport.SetEmbedded(CSS: TfrxCSS; Obj: TfrxView);
begin
  FEmbedded := True;
  FCSS := CSS;
