...
// (DO NOT EDIT: machine generated header) 'frxTransportIndyConnectorHTTP.pas' rev: 32.00 (Windows)
...
public:
	...
	__fastcall virtual ~TfrxTransportIndyConnectorHTTP(void);
	Idhttp::TIdHTTP* __fastcall GetIdHTTP(void);
