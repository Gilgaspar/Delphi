...
// (DO NOT EDIT: machine generated header) 'frxBarcodeDataMatrix.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxBarcodeDataMatrix : public Frxbarcode2dbase::TfrxBarcode2DBaseWithUnion
{
...
private:
	...
	int FCodePage;
	bool FGS1Rule;
	Frxbarcode2dbase::T2DBooleanArray ArrOB;
	void __fastcall SetGS1Rule(bool b);
	void __fastcall SetBit(int x, int y);
...
__published:
	...
	__property bool GS1Rule = {read=FGS1Rule, write=SetGS1Rule, nodefault};
};
