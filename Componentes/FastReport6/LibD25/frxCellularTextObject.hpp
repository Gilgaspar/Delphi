...
// (DO NOT EDIT: machine generated header) 'frxCellularTextObject.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TComponent.Destroy */ inline __fastcall virtual ~TfrxReportCellularTextObject(void) { }
...
private:
	...
	System::Extended __fastcall GetCellWidth(void);
	System::Extended __fastcall GetCellHeight(void);
	void __fastcall SetCellWidth(System::Extended Value);
	void __fastcall SetCellHeight(System::Extended Value);
...
__published:
	...
	__property System::Extended CellHeight = {read=FCellHeight, write=SetCellHeight};
...
public:
	/* TfrxCustomMemoView.Destroy */ inline __fastcall virtual ~TfrxCellularText(void) { }
