...
// (DO NOT EDIT: machine generated header) 'frxEditOptions.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxOptionsEditor : public Frxbaseform::TfrxBaseForm
{
...
__published:
	...
	Vcl::Stdctrls::TCheckBox* MultiBCB;
	Vcl::Stdctrls::TLabel* LGuidAcc;
	Vcl::Stdctrls::TEdit* EGuidAcc;
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxOptionsEditor(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxOptionsEditor(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxOptionsEditor(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxOptionsEditor(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
