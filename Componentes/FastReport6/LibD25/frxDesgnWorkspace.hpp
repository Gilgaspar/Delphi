...
// (DO NOT EDIT: machine generated header) 'frxDesgnWorkspace.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxDesignerWorkspace : public Frxdpiawarebasecontrols::TfrxDPIAwarePanel
{
	typedef Frxdpiawarebasecontrols::TfrxDPIAwarePanel inherited;
	
protected:
	bool FSkipPaintWindow;
	...
	void __fastcall UpdateInternalSelection(void);
...
public:
	...
	virtual void __fastcall ClearLastView(void);
	void __fastcall CreateInPlaceEditorsList(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxDesignerWorkspace(HWND ParentWindow) : Frxdpiawarebasecontrols::TfrxDPIAwarePanel(ParentWindow) { }
