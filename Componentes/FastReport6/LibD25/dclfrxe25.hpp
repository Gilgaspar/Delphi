...
// (DO NOT EDIT: machine generated header) 'dclfrxe25.dpk' rev: 32.00 (Windows)
...
#include <frxExportZPL.hpp>	// (frxe25)
#include <frxExportODF.hpp>	// (frxe25)
#include <frxBIFF.hpp>	// (frxe25)
#include <frxExportDOCX.hpp>	// (frxe25)
#include <frxExportPPTX.hpp>	// (frxe25)
#include <frxExportXLSX.hpp>	// (frxe25)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXE25)
using namespace Dclfrxe25;
#endif
#pragma pack(pop)
#pragma option pop
