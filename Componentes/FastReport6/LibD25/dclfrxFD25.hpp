...
// (DO NOT EDIT: machine generated header) 'dclfrxFD25.dpk' rev: 32.00 (Windows)

#ifndef Dclfrxfd25HPP
#define Dclfrxfd25HPP
...
#include <frxFDEditor.hpp>	// (frxFD25)
#include <FireDAC.Stan.Def.hpp>	// (FireDACCommon)
#include <FireDAC.Phys.hpp>	// (FireDACCommonDriver)
#include <frxFDComponents.hpp>	// (frxFD25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxfd25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxfd25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXFD25)
using namespace Dclfrxfd25;
#endif
#pragma pack(pop)
#pragma option pop
