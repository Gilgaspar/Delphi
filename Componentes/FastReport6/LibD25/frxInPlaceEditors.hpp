...
// (DO NOT EDIT: machine generated header) 'frxInPlaceEditors.pas' rev: 32.00 (Windows)
...
protected:
	...
	bool FEdited;
	virtual void __fastcall InitControlFromComponent(void);
	virtual void __fastcall InitComponentFromControl(void);
	void __fastcall EditDone(void);
	virtual void __fastcall CreateMemo(void) = 0 ;
	
public:
	__fastcall virtual TfrxInPlaceMemoEditorBase(Frxclass::TfrxComponentClass aClassRef, Vcl::Controls::TWinControl* aOwner);
	__fastcall virtual ~TfrxInPlaceMemoEditorBase(void);
...
protected:
	virtual void __fastcall CreateMemo(void);
public:
	...
	/* TfrxInPlaceMemoEditorBase.Destroy */ inline __fastcall virtual ~TfrxInPlaceTextEditorBase(void) { }
...
public:
	...
	/* TfrxInPlaceMemoEditorBase.Destroy */ inline __fastcall virtual ~TfrxInPlaceMemoEditor(void) { }
...
private:
	...
	bool FModified;
	void __fastcall UpdateRect(void);
	...
	Frxclass::TfrxDataSet* __fastcall GetParentDS(void);
...
public:
	...
	/* TfrxInPlaceEditor.Destroy */ inline __fastcall virtual ~TfrxInPlaceDataFiledEditor(void) { }
...
private:
	...
	bool __fastcall DestroyPanel(void);
...
public:
	__fastcall virtual ~TfrxInPlaceBasePanelEditor(void);
