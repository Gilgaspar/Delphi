...
// (DO NOT EDIT: machine generated header) 'frxGPXFileFormat.pas' rev: 32.00 (Windows)
...
public:
	/* TTaggedElement.Destroy */ inline __fastcall virtual ~TGPXAnyPoint(void) { }
...
public:
	__fastcall TGPXTrackSegment(void);
	__fastcall virtual ~TGPXTrackSegment(void);
...
public:
	__fastcall TGPXTrack(void);
	__fastcall virtual ~TGPXTrack(void);
...
private:
	...
	double FXmax;
	double FYmax;
	int __fastcall GetCountOfTracks(void);
	int __fastcall GetCountOfWayPoints(void);
...
public:
	...
	__fastcall virtual ~TGPXFile(void);
	bool __fastcall IsValidBounds(void);
