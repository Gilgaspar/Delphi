...
// (DO NOT EDIT: machine generated header) 'frxIOTransportBoxComBase.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseTransportDialog.Destroy */ inline __fastcall virtual ~TfrxBoxComIOTransportForm(void) { }
	
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxBoxComIOTransportForm(System::Classes::TComponent* AOwner) : Frxiotransporthelpers::TfrxBaseTransportDialog(AOwner) { }
...
public:
	...
	__fastcall virtual ~TfrxBaseBoxComIOTransport(void);
...
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBaseBoxComIOTransport(void) : Frxiotransporthelpers::TfrxHTTPIOTransport() { }
