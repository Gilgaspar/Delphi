...
// (DO NOT EDIT: machine generated header) 'frxCrossEditor.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxCrossEditorForm : public Frxbaseform::TfrxBaseForm
{
...
private:
	...
	bool FUpdating;
	int FSubTotOffset;
	System::Types::TRect FBtnColumnsLB;
	System::Types::TRect FBtnRowsLB;
	System::Types::TRect FBtnCellsLB;
	int FBitmapWidth;
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxCrossEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxCrossEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
