...
// (DO NOT EDIT: machine generated header) 'frxGaugeDialogControl.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TComponent.Destroy */ inline __fastcall virtual ~TfrxGaugeDialogControls(void) { }
...
protected:
	...
	virtual void __fastcall CreateGauge(void) = 0 ;
...
public:
	/* TfrxDialogControl.Destroy */ inline __fastcall virtual ~TfrxBaseGaugeControl(void) { }
...
private:
	Frxgauge::TfrxGauge* __fastcall GetGauge(void);
	
protected:
	virtual void __fastcall CreateGauge(void);
...
public:
	/* TfrxDialogControl.Destroy */ inline __fastcall virtual ~TfrxGaugeControl(void) { }
...
private:
	Frxgauge::TfrxIntervalGauge* __fastcall GetGauge(void);
...
public:
	/* TfrxDialogControl.Destroy */ inline __fastcall virtual ~TfrxIntervalGaugeControl(void) { }
