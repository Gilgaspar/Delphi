...
// (DO NOT EDIT: machine generated header) 'frxConnWizard.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxConnectionWizardForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxConnectionWizardForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxConnectionWizardForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxConnectionWizardForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxConnectionWizardForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
