...
// (DO NOT EDIT: machine generated header) 'frxDB25.dpk' rev: 32.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXDB25)
using namespace Frxdb25;
#endif
#pragma pack(pop)
#pragma option pop
