...
// (DO NOT EDIT: machine generated header) 'dclfsFD25.dpk' rev: 32.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSFD25)
using namespace Dclfsfd25;
#endif
#pragma pack(pop)
#pragma option pop
