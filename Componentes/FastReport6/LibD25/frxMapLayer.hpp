...
// (DO NOT EDIT: machine generated header) 'frxMapLayer.pas' rev: 32.00 (Windows)
...
public:
	...
	System::Extended __fastcall Get(void);
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TOperationCalculator(void) { }
...
public:
	...
	__fastcall virtual ~TValuesList(void);
	void __fastcall AddValue(System::UnicodeString SpatialValue, System::Extended AnalyticalValue);
	System::Extended __fastcall MinValue(void);
	System::Extended __fastcall MaxValue(void);
...
private:
	...
	bool FShowPoints;
	bool FShowPolygons;
	Frxmapshape::TShape* __fastcall GetSelectedShape(void);
	Frxmapcolorrangeform::TColorRangeCollection* __fastcall GetColorRangeData(void);
	Frxmapsizerangeform::TSizeRangeCollection* __fastcall GetSizeRangeData(void);
...
protected:
	...
	virtual System::UnicodeString __fastcall GetSelectedShapeName(void);
	virtual System::UnicodeString __fastcall GetSelectedShapeValue(void);
	virtual bool __fastcall IsHighlightSelectedShape(void);
	virtual bool __fastcall IsHiddenShape(int iRecord);
	void __fastcall GetDesigningData(void);
	virtual void __fastcall InitialiseData(void);
	virtual bool __fastcall IsCanGetData(void);
	void __fastcall FinaliseData(void);
	void __fastcall FillRanges(const Frxanaliticgeometry::TDoubleArray Values);
	virtual void __fastcall ExpandVariables(void);
...
public:
	...
	__fastcall virtual ~TfrxCustomLayer(void);
	...
	bool __fastcall IsSelectedShapeChanded(void);
	virtual void __fastcall GetColumnList(System::Classes::TStrings* List);
	void __fastcall ClearSelectedShape(void);
	bool __fastcall IsMercatorSuitable(void);
	void __fastcall SwapShapes(TfrxCustomLayer* EditedLayer);
	virtual void __fastcall CopyDatasets(TfrxCustomLayer* CustomLayer);
...
private:
	...
	TfrxCustomLayer* __fastcall GetSelectedLayer(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TMapLayerList(void) { }
...
private:
	...
	Frxmaphelpers::TfrxSumStringList* __fastcall GetFileTags(void);
...
protected:
	...
	virtual bool __fastcall IsCanGetData(void);
	virtual bool __fastcall IsHighlightSelectedShape(void);
	void __fastcall SetMapFileName(System::UnicodeString AMapFileName);
...
public:
	...
	__fastcall virtual ~TfrxMapFileLayer(void);
	virtual bool __fastcall IsHasZoomRect(/* out */ Frxclass::TfrxRect &ZoomRect);
	void __fastcall Embed(void);
	void __fastcall ReRead(void);
	void __fastcall JustAdded(void);
...
public:
	/* TfrxCustomLayer.Destroy */ inline __fastcall virtual ~TfrxApplicationLayer(void) { }
...
public:
	...
	virtual Frxdsgnintf::TfrxPropertyAttributes __fastcall GetAttributes(void);
...
public:
	...
	/* TfrxPropertyEditor.Destroy */ inline __fastcall virtual ~TfrxLabelColumnProperty(void) { }
...
extern DELPHI_PACKAGE void __fastcall GeoDataKindList(System::Classes::TStrings* List);
}	/* namespace Frxmaplayer */
