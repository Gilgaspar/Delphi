...
// (DO NOT EDIT: machine generated header) 'frxIOTransportDropbox.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxDropboxIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxDropboxIOTransport(void) : Frxiotransportdropboxbase::TfrxBaseDropboxIOTransport() { }
