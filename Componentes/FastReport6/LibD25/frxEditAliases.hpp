...
// (DO NOT EDIT: machine generated header) 'frxEditAliases.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxAliasesEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxAliasesEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxAliasesEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxAliasesEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxAliasesEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
