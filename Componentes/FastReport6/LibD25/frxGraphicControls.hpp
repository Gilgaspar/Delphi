...
// (DO NOT EDIT: machine generated header) 'frxGraphicControls.pas' rev: 32.00 (Windows)
...
public:
	__fastcall TfrxSwitchButtonsPanel(void);
	__fastcall virtual ~TfrxSwitchButtonsPanel(void);
	void __fastcall Draw(Vcl::Graphics::TCanvas* aCanvas, int aLeft, int aTop);
