...
// (DO NOT EDIT: machine generated header) 'frxEditVar.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxVarEditorForm : public Frxbaseform::TfrxBaseLoadSavePrefForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxVarEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseLoadSavePrefForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxVarEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseLoadSavePrefForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxVarEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxVarEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseLoadSavePrefForm(ParentWindow) { }
