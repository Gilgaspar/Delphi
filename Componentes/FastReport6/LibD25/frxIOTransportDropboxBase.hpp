...
// (DO NOT EDIT: machine generated header) 'frxIOTransportDropboxBase.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseTransportDialog.Destroy */ inline __fastcall virtual ~TfrxDropboxIOTransportForm(void) { }
	
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxDropboxIOTransportForm(System::Classes::TComponent* AOwner) : Frxiotransporthelpers::TfrxBaseTransportDialog(AOwner) { }
...
protected:
	...
	System::UnicodeString __fastcall GetListFolder(void);
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxBaseDropboxIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBaseDropboxIOTransport(void) : Frxiotransporthelpers::TfrxHTTPIOTransport() { }
