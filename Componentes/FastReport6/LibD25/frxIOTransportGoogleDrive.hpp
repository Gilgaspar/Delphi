...
// (DO NOT EDIT: machine generated header) 'frxIOTransportGoogleDrive.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TfrxBaseGoogleDriveIOTransport.Destroy */ inline __fastcall virtual ~TfrxGoogleDriveIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxGoogleDriveIOTransport(void) : Frxiotransportgoogledrivebase::TfrxBaseGoogleDriveIOTransport() { }
