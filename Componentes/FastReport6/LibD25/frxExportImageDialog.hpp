...
// (DO NOT EDIT: machine generated header) 'frxExportImageDialog.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxIMGExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
