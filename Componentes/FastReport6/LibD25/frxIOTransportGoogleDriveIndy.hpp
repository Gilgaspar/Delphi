...
// (DO NOT EDIT: machine generated header) 'frxIOTransportGoogleDriveIndy.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TfrxBaseGoogleDriveIOTransport.Destroy */ inline __fastcall virtual ~TfrxGoogleDriveIOTransportIndy(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxGoogleDriveIOTransportIndy(void) : Frxiotransportgoogledrivebase::TfrxBaseGoogleDriveIOTransport() { }
