...
// (DO NOT EDIT: machine generated header) 'frxAnaliticGeometry.pas' rev: 32.00 (Windows)
...
public:
	...
	bool __fastcall IsNear(void);
	bool __fastcall IsZero(void);
	__property int Index = {read=FIndex, nodefault};
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TMinDistance(void) { }
