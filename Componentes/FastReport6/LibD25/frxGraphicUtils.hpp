...
// (DO NOT EDIT: machine generated header) 'frxGraphicUtils.pas' rev: 32.00 (Windows)
...
private:
	...
	void __fastcall FreeTempArray(void);
...
public:
	...
	void __fastcall LockCanvas(void);
	void __fastcall UnlockCanvas(void);
