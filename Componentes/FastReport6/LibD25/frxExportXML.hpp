...
private:
	...
	bool __fastcall GetOpenExcel(void);
...
public:
	/* TfrxCustomExportFilter.CreateNoRegister */ inline __fastcall TfrxXMLExport(void) : Frxexportbasedialog::TfrxBaseDialogExportFilter() { }
