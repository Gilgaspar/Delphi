...
// (DO NOT EDIT: machine generated header) 'frxEditTabOrder.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxTabOrderEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxTabOrderEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxTabOrderEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
