...
// (DO NOT EDIT: machine generated header) 'frxGaugeEditor.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxGaugeEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxGaugeEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxGaugeEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxGaugeEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxGaugeEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
