...
// (DO NOT EDIT: machine generated header) 'frxServerUtils.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TfrxServerFormat : unsigned char { sfHTM, sfXML, sfXLS, sfRTF, sfCSV, sfTXT, sfPDF, sfJPG, sfBMP, sfTIFF, sfGIF, sfFRP, sfODS, sfODT, sfHTMD };

typedef System::Set<TfrxServerFormat, TfrxServerFormat::sfHTM, TfrxServerFormat::sfHTMD> TfrxServerOutputFormats;
