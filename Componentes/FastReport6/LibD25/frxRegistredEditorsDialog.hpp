...
// (DO NOT EDIT: machine generated header) 'frxRegistredEditorsDialog.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxRegEditorsDialog : public Frxbaseform::TfrxBaseForm
{
...
__published:
	...
	void __fastcall EditorsVLDrawCell(System::TObject* Sender, int ACol, int ARow, const System::Types::TRect &aRect, Vcl::Grids::TGridDrawState State);
...
private:
	...
	void __fastcall FillComponentsList(void);
	void __fastcall FillEditors(void);
	
public:
	virtual void __fastcall UpdateFormPPI(int aNewPPI);
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxRegEditorsDialog(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxRegEditorsDialog(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxRegEditorsDialog(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxRegEditorsDialog(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
