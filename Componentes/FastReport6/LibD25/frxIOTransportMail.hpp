...
// (DO NOT EDIT: machine generated header) 'frxIOTransportMail.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxMailIOTransportForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxMailIOTransportForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxMailIOTransportForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxMailIOTransportForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxMailIOTransportForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
...
public:
	...
	__fastcall virtual ~TfrxMailIOTransport(void);
...
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxMailIOTransport(void) : Frxclass::TfrxCustomIOTransport() { }
