...
// (DO NOT EDIT: machine generated header) 'frxZipCode.pas' rev: 32.00 (Windows)
...
class DELPHICLASS TfrxZipCodeObject;
class DELPHICLASS TfrxZipCodeView;
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TZipCodeKind : unsigned char { zcCustom, zcInternational, zcRF, zcSample };

class PASCALIMPLEMENTATION TfrxZipCodeObject : public System::Classes::TComponent
{
	typedef System::Classes::TComponent inherited;
	
public:
	/* TComponent.Create */ inline __fastcall virtual TfrxZipCodeObject(System::Classes::TComponent* AOwner) : System::Classes::TComponent(AOwner) { }
	/* TComponent.Destroy */ inline __fastcall virtual ~TfrxZipCodeObject(void) { }
...
public:
	/* TfrxView.Destroy */ inline __fastcall virtual ~TfrxZipCodeView(void) { }
