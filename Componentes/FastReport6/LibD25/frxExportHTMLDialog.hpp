...
// (DO NOT EDIT: machine generated header) 'frxExportHTMLDialog.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxHTMLExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
