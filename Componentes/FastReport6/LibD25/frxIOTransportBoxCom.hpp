...
// (DO NOT EDIT: machine generated header) 'frxIOTransportBoxCom.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TfrxBaseBoxComIOTransport.Destroy */ inline __fastcall virtual ~TfrxBoxComIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBoxComIOTransport(void) : Frxiotransportboxcombase::TfrxBaseBoxComIOTransport() { }
