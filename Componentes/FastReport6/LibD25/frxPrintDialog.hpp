...
// (DO NOT EDIT: machine generated header) 'frxPrintDialog.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxPrintDialog : public Frxbaseform::TfrxBaseForm
{
...
private:
	int OldIndex;
	Vcl::Extctrls::TImage* FCollateScale;
	Vcl::Extctrls::TImage* FNonCollateScale;
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxPrintDialog(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxPrintDialog(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxPrintDialog(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxPrintDialog(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
