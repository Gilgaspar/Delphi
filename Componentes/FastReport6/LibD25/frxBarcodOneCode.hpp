...
// (DO NOT EDIT: machine generated header) 'frxBarcodOneCode.pas' rev: 32.00 (Windows)
...
public:
	__fastcall TOneCode(void);
	System::AnsiString __fastcall Bars(System::AnsiString source);
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TOneCode(void) { }
