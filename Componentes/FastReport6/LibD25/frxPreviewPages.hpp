...
// (DO NOT EDIT: machine generated header) 'frxPreviewPages.pas' rev: 32.00 (Windows)
...
public:
	...
	Frxxml::TfrxXMLItem* __fastcall FindAnchorRoot(void);
	...
	void __fastcall LockPage(void);
	void __fastcall UnlockPage(void);
