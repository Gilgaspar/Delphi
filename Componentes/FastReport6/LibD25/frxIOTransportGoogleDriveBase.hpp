...
// (DO NOT EDIT: machine generated header) 'frxIOTransportGoogleDriveBase.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseTransportDialog.Destroy */ inline __fastcall virtual ~TfrxGoogleDriveIOTransportForm(void) { }
	
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxGoogleDriveIOTransportForm(System::Classes::TComponent* AOwner) : Frxiotransporthelpers::TfrxBaseTransportDialog(AOwner) { }
...
public:
	...
	__fastcall virtual ~TfrxBaseGoogleDriveIOTransport(void);
...
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBaseGoogleDriveIOTransport(void) : Frxiotransporthelpers::TfrxHTTPIOTransport() { }
