...
// (DO NOT EDIT: machine generated header) 'frxMapShape.pas' rev: 32.00 (Windows)
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TShapeStyle(void) { }
...
private:
	...
	Frxmaphelpers::TShapeType __fastcall GetShapeType(void);
	System::UnicodeString __fastcall GetLegend(const System::UnicodeString Name);
	int __fastcall GetPartCount(void);
	Frxclass::TfrxPoint __fastcall GetShapeCenter(void);
	System::Classes::TStringList* __fastcall GetShapeTags(void);
...
public:
	...
	__fastcall TShape(void);
	__fastcall virtual ~TShape(void);
	bool __fastcall IsValueEmpty(void);
...
public:
	/* TShape.CreateClear */ inline __fastcall TAdjustableShape(void) : TShape() { }
	/* TShape.Destroy */ inline __fastcall virtual ~TAdjustableShape(void) { }
...
public:
	...
	void __fastcall SetMapRectByData(void);
...
public:
	/* TList.Destroy */ inline __fastcall virtual ~TShapeList(void) { }
...
public:
	__fastcall TOSMFileList(void);
	__fastcall virtual ~TOSMFileList(void);
...
public:
	/* TList.Destroy */ inline __fastcall virtual ~TOSMShapeList(void) { }
...
public:
	/* TList.Destroy */ inline __fastcall virtual ~TGPXShapeList(void) { }
...
public:
	/* TList.Destroy */ inline __fastcall virtual ~TERSIShapeList(void) { }
