...
class PASCALIMPLEMENTATION TfrxRuler : public Frxdpiawarebasecontrols::TfrxDPIAwarePanel
{
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxRuler(HWND ParentWindow) : Frxdpiawarebasecontrols::TfrxDPIAwarePanel(ParentWindow) { }
...
class PASCALIMPLEMENTATION TfrxCustomSelector : public Frxdpiawarebasecontrols::TfrxDPIAwarePanel
{
	typedef Frxdpiawarebasecontrols::TfrxDPIAwarePanel inherited;
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxCustomSelector(HWND ParentWindow) : Frxdpiawarebasecontrols::TfrxDPIAwarePanel(ParentWindow) { }
...
protected:
	System::Types::TSize __fastcall CalcSize(void);
...
protected:
	virtual void __fastcall DrawEdge(int X, int Y, bool IsDown);
	DYNAMIC void __fastcall MouseUp(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
	int __fastcall GetScaledSize(void);
...
class PASCALIMPLEMENTATION TfrxLineStyleControl : public Frxdpiawarebasecontrols::TfrxDPIAwareCustomControl
{
	typedef Frxdpiawarebasecontrols::TfrxDPIAwareCustomControl inherited;
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxLineStyleControl(HWND ParentWindow) : Frxdpiawarebasecontrols::TfrxDPIAwareCustomControl(ParentWindow) { }
