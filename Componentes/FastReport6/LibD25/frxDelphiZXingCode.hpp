...
// (DO NOT EDIT: machine generated header) 'frxDelphiZXIngCode.pas' rev: 32.00 (Windows)
...
public:
	...
	__fastcall virtual ~TGenericGF(void);
	TGenericGFPoly* __fastcall GetZero(void);
	int __fastcall Exp(int A);
	int __fastcall GetGeneratorBase(void);
...
public:
	...
	__fastcall virtual ~TGenericGFPoly(void);
	TIntegerArray __fastcall Coefficients(void);
	...
	TIntegerArray __fastcall GetCoefficients(void);
	bool __fastcall IsZero(void);
	int __fastcall GetCoefficient(int Degree);
	int __fastcall GetDegree(void);
...
public:
	...
	__fastcall virtual ~TReedSolomonEncoder(void);
...
public:
	__fastcall TBitArray(void)/* overload */;
	__fastcall TBitArray(const int Size)/* overload */;
	void __fastcall Clear(void);
	int __fastcall GetSizeInBytes(void);
