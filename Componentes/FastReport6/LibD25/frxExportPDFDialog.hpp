...
// (DO NOT EDIT: machine generated header) 'frxExportPDFDialog.pas' rev: 32.00 (Windows)
...
__published:
	...
	Vcl::Stdctrls::TCheckBox* IFormsCB;
	Vcl::Stdctrls::TLabel* FontGLB;
	Vcl::Stdctrls::TEdit* FSubsetED;
	void __fastcall PDFStandardComboBoxChange(System::TObject* Sender);
	void __fastcall IFormsCBClick(System::TObject* Sender);
	
protected:
	void __fastcall SetupComboBox(Vcl::Stdctrls::TComboBox* ComboBox, System::UnicodeString st);
	void __fastcall DoStandard(void);
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxPDFExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
