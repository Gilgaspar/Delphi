...
// (DO NOT EDIT: machine generated header) 'frxExportODFDialog.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxODFExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
