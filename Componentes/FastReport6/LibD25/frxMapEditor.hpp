...
// (DO NOT EDIT: machine generated header) 'frxMapEditor.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxMapEditorForm : public Frxbaseform::TfrxBaseForm
{
...
__published:
	...
	Vcl::Stdctrls::TComboBox* MapDataSetComboBox;
	Vcl::Stdctrls::TLabel* MapDataSetLabel;
	Vcl::Stdctrls::TComboBox* GeoDataKindComboBox;
	Vcl::Stdctrls::TLabel* GeoDataKindLabel;
...
private:
	...
	void __fastcall PopulateMapOptions(void);
	void __fastcall PopulateLayerOptions(void);
	Frxmaplayer::TfrxCustomLayer* __fastcall SelectedLayer(void);
	Frxmaphelpers::TLayerType __fastcall SelectedLayerType(void);
	Frxmaplayer::TfrxMapFileLayer* __fastcall SelectedMapFileLayer(void);
	Frxmaplayer::TfrxApplicationLayer* __fastcall SelectedApplicationLayer(void);
	Frxmapgeodatalayer::TfrxMapGeodataLayer* __fastcall SelectedGeodataLayer(void);
...
public:
	__fastcall virtual TfrxMapEditorForm(System::Classes::TComponent* AOwner);
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxMapEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxMapEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxMapEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
