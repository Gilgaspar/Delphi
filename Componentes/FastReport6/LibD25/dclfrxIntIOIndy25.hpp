...
// (DO NOT EDIT: machine generated header) 'dclfrxIntIOIndy25.dpk' rev: 32.00 (Windows)

#ifndef Dclfrxintioindy25HPP
#define Dclfrxintioindy25HPP
...
#include <frxIOTransportFTP.hpp>	// (frxIntIOIndy25)
...
namespace Dclfrxintioindy25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxintioindy25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXINTIOINDY25)
using namespace Dclfrxintioindy25;
#endif
#pragma pack(pop)
#pragma option pop
