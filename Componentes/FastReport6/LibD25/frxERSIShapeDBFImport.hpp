...
// (DO NOT EDIT: machine generated header) 'frxERSIShapeDBFImport.pas' rev: 32.00 (Windows)
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TERSIDBFFileColumn(void) { }
...
public:
	...
	__fastcall virtual ~TERSIDBFFile(void);
	void __fastcall GetColumnList(System::Classes::TStrings* List);
	bool __fastcall IsUTF8(void);
