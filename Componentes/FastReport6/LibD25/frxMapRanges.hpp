...
// (DO NOT EDIT: machine generated header) 'frxMapRanges.pas' rev: 32.00 (Windows)
...
public:
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TMapRangeItem(void) { }
...
protected:
	...
	double __fastcall MedianValue(void);
...
public:
	...
	/* TCollection.Destroy */ inline __fastcall virtual ~TMapRangeCollection(void) { }
...
private:
	...
	int __fastcall GetValuesHeight(void);
...
public:
	...
	__fastcall virtual ~TMapRanges(void);
