...
// (DO NOT EDIT: machine generated header) 'frxFD25.dpk' rev: 32.00 (Windows)
...
#include <SysInit.hpp>
#include <frxFDComponents.hpp>
#include <frxFDEditor.hpp>
#include <frxFDRTTI.hpp>
...
#include <fs_iFDRTTI.hpp>	// (fsFD25)
#include <FireDAC.Stan.Async.hpp>	// (FireDACCommon)
#include <FireDAC.Comp.Script.hpp>	// (FireDAC)
#include <FireDAC.DApt.hpp>	// (FireDACCommonDriver)
#include <FireDAC.Comp.ScriptCommands.hpp>	// (FireDAC)
#include <FireDAC.VCLUI.Login.hpp>	// (vclFireDAC)
#include <FireDAC.VCLUI.Script.hpp>	// (vclFireDAC)
#include <FireDAC.Stan.Def.hpp>	// (FireDACCommon)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXFD25)
using namespace Frxfd25;
#endif
#pragma pack(pop)
#pragma option pop
