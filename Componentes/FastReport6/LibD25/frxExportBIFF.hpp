...
// (DO NOT EDIT: machine generated header) 'frxExportBIFF.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxCustomExportFilter.CreateNoRegister */ inline __fastcall TfrxBIFFExport(void) : Frxexportbasedialog::TfrxBaseDialogExportFilter() { }
