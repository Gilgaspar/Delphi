...
// (DO NOT EDIT: machine generated header) 'frxMapILEditor.pas' rev: 32.00 (Windows)
...
public:
	...
	void __fastcall CalcCanvas(void);
	void __fastcall CalcMap(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TCanvasMapPair(void) { }
...
protected:
	...
	virtual void __fastcall ReadShapeData(void) = 0 ;
...
public:
	...
	virtual void __fastcall RecalcCanvas(void);
	virtual TVirtualCursor __fastcall GetCursor(const int X, const int Y) = 0 ;
	virtual Frxmaphelpers::TShapeType __fastcall ShapeType(void) = 0 ;
	virtual Frxmaphelpers::TShapeData* __fastcall GetShapeData(System::Classes::TStrings* Strings) = 0 ;
	virtual bool __fastcall IsCanDeletePoint(void);
	virtual bool __fastcall IsCanDeleteShape(void);
	virtual bool __fastcall IsCanSave(void);
	virtual bool __fastcall IsCanVK_DELETE(void);
	virtual void __fastcall DeletePoint(void);
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TfrxMapILEditorForm : public Frxbaseform::TfrxBaseForm
{
...
protected:
	...
	System::UnicodeString __fastcall NextTemplateName(void);
	...
	Frxmaphelpers::TShapeType __fastcall NextFigureShapeType(void);
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxMapILEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxMapILEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxMapILEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxMapILEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
