...
// (DO NOT EDIT: machine generated header) 'dclfrxcs25.dpk' rev: 32.00 (Windows)

#ifndef Dclfrxcs25HPP
#define Dclfrxcs25HPP
...
#include <frxServerConfig.hpp>	// (frxcs25)
#include <frxServerFormControls.hpp>	// (frxcs25)
#include <frxServerReportsList.hpp>	// (frxcs25)
#include <frxServerCache.hpp>	// (frxcs25)
#include <frxExportODF.hpp>	// (frxe25)
#include <frxServerPrinter.hpp>	// (frxcs25)
#include <frxBIFF.hpp>	// (frxe25)
#include <frxServerSessionManager.hpp>	// (frxcs25)
#include <frxUsers.hpp>	// (frxcs25)
#include <frxServerClient.hpp>	// (frxcs25)
#include <frxServer.hpp>	// (frxcs25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxcs25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxcs25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXCS25)
using namespace Dclfrxcs25;
#endif
#pragma pack(pop)
#pragma option pop
