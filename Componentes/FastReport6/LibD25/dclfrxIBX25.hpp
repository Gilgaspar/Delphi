...
// (DO NOT EDIT: machine generated header) 'dclfrxIBX25.dpk' rev: 32.00 (Windows)

#ifndef Dclfrxibx25HPP
#define Dclfrxibx25HPP
...
#include <fs_iibxrtti.hpp>	// (fsIBX25)
#include <frxIBXRTTI.hpp>	// (frxIBX25)
#include <frxIBXEditor.hpp>	// (frxIBX25)
#include <frxIBXComponents.hpp>	// (frxIBX25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxibx25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxibx25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXIBX25)
using namespace Dclfrxibx25;
#endif
#pragma pack(pop)
#pragma option pop
