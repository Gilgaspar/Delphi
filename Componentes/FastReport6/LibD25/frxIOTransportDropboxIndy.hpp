...
// (DO NOT EDIT: machine generated header) 'frxIOTransportDropboxIndy.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxDropboxIOTransportIndy(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxDropboxIOTransportIndy(void) : Frxiotransportdropboxbase::TfrxBaseDropboxIOTransport() { }
