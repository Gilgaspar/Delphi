...
// (DO NOT EDIT: machine generated header) 'frxIOTransportBoxComIndy.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TfrxBaseBoxComIOTransport.Destroy */ inline __fastcall virtual ~TfrxBoxComIOTransportIndy(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBoxComIOTransportIndy(void) : Frxiotransportboxcombase::TfrxBaseBoxComIOTransport() { }
