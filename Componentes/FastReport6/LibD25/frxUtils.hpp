...
// (DO NOT EDIT: machine generated header) 'frxUtils.pas' rev: 32.00 (Windows)
...
public:
	/* TMetafile.Create */ inline __fastcall virtual TfrxMetafile(void) : Vcl::Graphics::TMetafile() { }
	/* TMetafile.Destroy */ inline __fastcall virtual ~TfrxMetafile(void) { }
