...
// (DO NOT EDIT: machine generated header) 'frxDCtrl.pas' rev: 32.00 (Windows)
...
private:
	...
	Vcl::Comctrls::TTabStyle __fastcall GetStyle(void);
	short __fastcall GetTabHeight(void);
	int __fastcall GetTabIndex(void);
	int __fastcall GetTabOrder(void);
	Vcl::Comctrls::TTabPosition __fastcall GetTabPosition(void);
...
__published:
	...
	__property OnMouseUp = {default=0};
public:
	/* TfrxDialogControl.Destroy */ inline __fastcall virtual ~TfrxPageControl(void) { }
...
protected:
	...
	virtual void __fastcall SetParent(Frxclass::TfrxComponent* AParent);
	HIDESBASE void __fastcall DoSetParent(void);
...
__published:
	...
	__property OnMouseUp = {default=0};
public:
	/* TfrxDialogControl.Destroy */ inline __fastcall virtual ~TfrxTabSheet(void) { }
...
protected:
	...
	virtual System::Uitypes::TEditCharCase __fastcall GetCharCase(void);
