...
// (DO NOT EDIT: machine generated header) 'frxMapGeodataLayer.pas' rev: 32.00 (Windows)
...
protected:
	...
	void __fastcall LoadShapes(void);
	virtual bool __fastcall IsCanGetData(void);
	bool __fastcall IsWideText(void);
...
public:
	...
	virtual void __fastcall CopyDatasets(Frxmaplayer::TfrxCustomLayer* CustomLayer);
...
public:
	/* TfrxCustomLayer.Destroy */ inline __fastcall virtual ~TfrxMapGeodataLayer(void) { }
