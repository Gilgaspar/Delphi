...
// (DO NOT EDIT: machine generated header) 'frxMap.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TComponent.Destroy */ inline __fastcall virtual ~TfrxMapObject(void) { }
...
private:
	...
	System::UnicodeString __fastcall GetSelectedShapeName(void);
...
protected:
	...
	Frxclass::TfrxPoint __fastcall CanvasSize(void);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	void __fastcall InitConverter(void);
	bool __fastcall IsAlignByZoomPolygon(void);
	void __fastcall ZoomRecenter(System::Extended CenterX, System::Extended CenterY, System::Extended Factor);
	void __fastcall EnableSupportedHyperlink(void);
	void __fastcall DisableSupportedHyperlink(void);
	bool __fastcall ShowMoveArrow(void);
	
public:
	__fastcall virtual TfrxMapView(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TfrxMapView(void);
