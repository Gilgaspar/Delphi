...
// (DO NOT EDIT: machine generated header) 'frxNewItem.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxNewItemForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxNewItemForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxNewItemForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
