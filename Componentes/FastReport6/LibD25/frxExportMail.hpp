...
// (DO NOT EDIT: machine generated header) 'frxExportMail.pas' rev: 32.00 (Windows)
...
public:
	...
	virtual Frxclass::TfrxCustomIOTransport* __fastcall CreateDefaultIOTransport(void);
