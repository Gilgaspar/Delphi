...
// (DO NOT EDIT: machine generated header) 'frxPolygonTemplate.pas' rev: 32.00 (Windows)
...
public:
	...
	__fastcall virtual ~TPointIndexByName(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TAbstractTemplateComponent(void) { }
...
public:
	__fastcall TTemplateComponentList(void);
	__property TAbstractTemplateComponent* Items[int Index] = {read=GetItems, write=SetItems/*, default*/};
public:
	/* TList.Destroy */ inline __fastcall virtual ~TTemplateComponentList(void) { }
...
public:
	...
	__fastcall virtual ~TfrxPolygonTemplate(void);
...
public:
	/* TList.Destroy */ inline __fastcall virtual ~TfrxPolygonTemplateList(void) { }
