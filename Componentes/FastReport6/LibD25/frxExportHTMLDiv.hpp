...
public:
	...
	void __fastcall DoPositive(void);
...
protected:
	...
	void __fastcall StartAnchors(void);
	void __fastcall StartNavigator(void);
	virtual void __fastcall CreateCSS(void);
...
public:
	/* TfrxCustomExportFilter.CreateNoRegister */ inline __fastcall TfrxHTMLDivExport(void) : Frxexporthelpers::TExportHTMLDivSVGParent() { }
