...
// (DO NOT EDIT: machine generated header) 'frxMapLayerTags.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TMapLayerTagsForm : public Frxbaseform::TfrxBaseForm
{
...
protected:
	...
	int FTagId;
	void __fastcall FillFileTags(void);
	bool __fastcall IsInLayerTags(System::UnicodeString st);
	bool __fastcall IsEditFilter(System::UnicodeString st);
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TMapLayerTagsForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TMapLayerTagsForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TMapLayerTagsForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TMapLayerTagsForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
