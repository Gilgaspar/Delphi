...
// (DO NOT EDIT: machine generated header) 'frxInsp.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxObjectInspector : public Frxbaseform::TfrxBaseForm
{
...
private:
	...
	Vcl::Graphics::TBitmap* FComboBtnGlyph;
	Vcl::Graphics::TBitmap* FEditBtnGlyph;
	System::UnicodeString FFilter;
	Frxctrls::TfrxFilterEdit* FFilterEdit;
	int FFileterMinWidth;
	int FFileterMaxWidth;
	System::Uitypes::TColor FColor;
	System::Classes::TStringList* FSavedPositions;
	bool FSavePosLocked;
	int FMaxSavedPos;
	...
	void __fastcall PBOnDragDrop(System::TObject* Sender, System::TObject* Source, int X, int Y);
	void __fastcall PBOnDragOver(System::TObject* Sender, System::TObject* Source, int X, int Y, System::Uitypes::TDragState State, bool &Accept);
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxObjectInspector(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxObjectInspector(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
