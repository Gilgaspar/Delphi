...
// (DO NOT EDIT: machine generated header) 'frxMapInteractiveLayer.pas' rev: 32.00 (Windows)
...
public:
	...
	void __fastcall RemoveEditedShape(void);
	__property Frxmapshape::TShape* EditedShape = {read=FEditedShape};
	
__published:
	__property LabelColumn = {default=0};
public:
	/* TfrxCustomLayer.Destroy */ inline __fastcall virtual ~TfrxMapInteractiveLayer(void) { }
