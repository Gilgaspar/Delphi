...
class DELPHICLASS TfrxClassNameProperty;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TfrxClassNameProperty : public TfrxStringProperty
{
	typedef TfrxStringProperty inherited;
...
public:
	...
	virtual void __fastcall SetValue(const System::UnicodeString Value);
public:
	/* TfrxPropertyEditor.Create */ inline __fastcall virtual TfrxClassNameProperty(Frxclass::TfrxCustomDesigner* Designer) : TfrxStringProperty(Designer) { }
	/* TfrxPropertyEditor.Destroy */ inline __fastcall virtual ~TfrxClassNameProperty(void) { }
...
public:
	...
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TfrxSaveFilterItem(void) { }
...
public:
	__fastcall TfrxSaveFiltersCollection(void);
...
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TfrxSaveFiltersCollection(void) { }
...
extern DELPHI_PACKAGE TfrxPropertyList* __fastcall frxCreatePropertyList(System::Classes::TList* ComponentList, Frxclass::TfrxCustomDesigner* Designer, System::UnicodeString aFilter = System::UnicodeString());
