...
// (DO NOT EDIT: machine generated header) 'frxMapSizeRangeForm.pas' rev: 32.00 (Windows)
...
public:
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TSizeRangeItem(void) { }
...
public:
	__fastcall TSizeRangeCollection(void);
	HIDESBASE TSizeRangeItem* __fastcall Add(void);
...
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TSizeRangeCollection(void) { }
	
};


class PASCALIMPLEMENTATION TMapSizeRangeForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	...
	TSizeRangeCollection* __fastcall GetCollection(void);
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TMapSizeRangeForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TMapSizeRangeForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TMapSizeRangeForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TMapSizeRangeForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
...
protected:
	...
	void __fastcall FillRangeSizes(void);
	virtual int __fastcall GetSpaceWidth(void);
	virtual int __fastcall GetStepWidth(void);
...
public:
	/* TMapRanges.Destroy */ inline __fastcall virtual ~TfrxSizeRanges(void) { }
