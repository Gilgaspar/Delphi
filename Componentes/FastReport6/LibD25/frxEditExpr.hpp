...
// (DO NOT EDIT: machine generated header) 'frxEditExpr.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxExprEditorForm : public Frxbaseform::TfrxBaseLoadSavePrefForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxExprEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseLoadSavePrefForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxExprEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseLoadSavePrefForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxExprEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxExprEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseLoadSavePrefForm(ParentWindow) { }
