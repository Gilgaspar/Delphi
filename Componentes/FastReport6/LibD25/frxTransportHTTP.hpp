...
// (DO NOT EDIT: machine generated header) 'frxTransportHTTP.pas' rev: 32.00 (Windows)
...
protected:
	...
	void __fastcall SureEmptyLineAtEnd(void);
	
public:
	__fastcall TfrxHTTPRequest(void);
	__fastcall virtual ~TfrxHTTPRequest(void);
	virtual void __fastcall BuildRequest(void);
	void __fastcall Redirect(const System::AnsiString NewAddress);
	bool __fastcall IsValidAddress(void);
...
protected:
	...
	unsigned StreamSize;
	void __fastcall SetSocketDestination(void);
...
public:
	...
	__fastcall virtual ~TfrxTransportHTTP(void);
