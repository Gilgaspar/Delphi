...
// (DO NOT EDIT: machine generated header) 'frxCross.pas' rev: 32.00 (Windows)
...
__published:
	...
	__property bool ShowCellBreak = {read=FShowCellBreak, write=FShowCellBreak, default=1};
