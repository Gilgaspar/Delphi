...
// (DO NOT EDIT: machine generated header) 'frxDesgn.pas' rev: 32.00 (Windows)
...
enum DECLSPEC_DENUM TfrxDesignerUpdateEvent : unsigned char { fduLoadReport, fduSaveReport };

typedef void __fastcall (__closure *TfrxAfterUpdateReportEvent)(System::TObject* Sender, TfrxDesignerUpdateEvent EventType, Frxclass::TfrxReport* Report);
...
typedef System::Set<Frxclass::TfrxDesignerRestriction, Frxclass::TfrxDesignerRestriction::drDontInsertObject, Frxclass::TfrxDesignerRestriction::drDontEditInternalDatasets> TfrxDesignerRestrictions;
...
private:
	...
	TfrxAfterUpdateReportEvent FOnAfterUpdateReport;
...
__published:
	...
	__property TfrxAfterUpdateReportEvent OnAfterUpdateReport = {read=FOnAfterUpdateReport, write=FOnAfterUpdateReport};
...
private:
	...
	System::Extended __fastcall GetStickAccuracy(void);
	...
	void __fastcall SetStickAccuracy(const System::Extended Value);
	void __fastcall SetChange(void);
	void __fastcall UnSetChange(void);
	void __fastcall DoAfterUpdateReport(TfrxDesignerUpdateEvent EventType);
	Vcl::Controls::TWinControl* __fastcall GetCurrentForm(void);
	int __fastcall TopRulerDialogForm(void);
	int __fastcall LeftRulerDialogForm(void);
...
protected:
	...
	HIDESBASE void __fastcall ScaleControls(void);
	...
	virtual Frxbaseform::TfrxPreferencesTypes __fastcall GetAvailablePreferences(void);
...
public:
	__fastcall virtual ~TfrxDesignerForm(void);
	virtual bool __fastcall CheckOp(Frxclass::TfrxDesignerRestriction Op);
	...
	virtual bool __fastcall IsDataTree(System::TObject* aObject);
	virtual System::UnicodeString __fastcall GetDataSelectedAsExp(void);
	...
	virtual void __fastcall ReportDataEdit(void);
	virtual void __fastcall ReportEditVariable(void);
	...
	__property System::Extended StickAccuracy = {read=GetStickAccuracy, write=SetStickAccuracy};
public:
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxDesignerForm(System::Classes::TComponent* AOwner) : Frxclass::TfrxCustomDesigner(AOwner) { }
