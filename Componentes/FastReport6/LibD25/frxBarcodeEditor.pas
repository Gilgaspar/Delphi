...
begin
  ...
  if Barcode.Typ = bcCodeUSPSIntelligentMail then
    ...
    Barcode.Text := '123456'
  else if Barcode.Typ = bcDeutsche_Post_Identcode then
    Barcode.Text := '01234567890'
  else if Barcode.Typ = bcDeutsche_Post_Leitcode then
  ...
  begin
    ...
    Barcode.DrawBarcode(ExamplePB.Canvas, Rect(40, 20, ExamplePB.Width - 40, 200),
      ViewTextCB.Checked, Self.CurrentFormPPI / frx_DefaultPPI, 1);
  end;
