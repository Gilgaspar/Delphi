...
// (DO NOT EDIT: machine generated header) 'frxEditMD.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxMDEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxMDEditorForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxMDEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxMDEditorForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxMDEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
