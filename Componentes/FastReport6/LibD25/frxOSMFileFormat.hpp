...
// (DO NOT EDIT: machine generated header) 'frxOSMFileFormat.pas' rev: 32.00 (Windows)
...
public:
	/* TTaggedElement.Destroy */ inline __fastcall virtual ~TOSMNode(void) { }
...
public:
	__fastcall TOSMWay(void);
	__fastcall virtual ~TOSMWay(void);
...
private:
	...
	double FXmax;
	double FYmax;
	int __fastcall GetCountOfNodes(void);
	int __fastcall GetCountOfWays(void);
...
public:
	...
	__fastcall virtual ~TOSMFile(void);
