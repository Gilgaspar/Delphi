...
// (DO NOT EDIT: machine generated header) 'frxIOTransportOneDriveBase.pas' rev: 32.00 (Windows)
...
private:
	...
	bool __fastcall IsGetToken(void);
...
public:
	/* TfrxBaseTransportDialog.Destroy */ inline __fastcall virtual ~TfrxOneDriveIOTransportForm(void) { }
	
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxOneDriveIOTransportForm(System::Classes::TComponent* AOwner) : Frxiotransporthelpers::TfrxBaseTransportDialog(AOwner) { }
...
private:
	...
	System::UnicodeString __fastcall GetRemoteDir(void);
...
protected:
	...
	virtual System::UnicodeString __fastcall GetListFolder(void) = 0 ;
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxBaseOneDriveIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxBaseOneDriveIOTransport(void) : Frxiotransporthelpers::TfrxHTTPIOTransport() { }
