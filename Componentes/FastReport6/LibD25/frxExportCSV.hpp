...
// (DO NOT EDIT: machine generated header) 'frxExportCSV.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxCustomExportFilter.CreateNoRegister */ inline __fastcall TfrxCSVExport(void) : Frxexportbasedialog::TfrxBaseDialogExportFilter() { }
