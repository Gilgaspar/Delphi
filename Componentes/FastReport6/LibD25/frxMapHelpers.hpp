...
// (DO NOT EDIT: machine generated header) 'frxMapHelpers.pas' rev: 32.00 (Windows)
...
private:
	...
	Frxanaliticgeometry::TDoublePoint __fastcall GetPoint(void);
	...
	Frxanaliticgeometry::TDoubleRect __fastcall GetRect(void);
	...
	int __fastcall GetMultiPointCount(void);
...
public:
	/* TObject.Create */ inline __fastcall TShapeData(void) : System::TObject() { }
...
public:
	...
	System::Extended __fastcall AspectRatio(void);
	...
	void __fastcall IgnoreShape(void);
...
public:
	/* TObject.Create */ inline __fastcall TMapToCanvasCoordinateConverter(void) : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TMapToCanvasCoordinateConverter(void) { }
...
public:
	__fastcall TTaggedElement(void);
	__fastcall virtual ~TTaggedElement(void);
...
protected:
	...
	void __fastcall DefineValueDlm(System::UnicodeString Text);
	void __fastcall ChangeValueDlm(System::UnicodeString &Text);
	
public:
	__fastcall TfrxMapXMLReader(System::Classes::TStream* Stream);
	bool __fastcall IsReadMapXMLRootItem(Frxxml::TfrxXMLItem* Item);
	bool __fastcall IsReadMapXMLItem(Frxxml::TfrxXMLItem* Item);
public:
	/* TfrxXMLReader.Destroy */ inline __fastcall virtual ~TfrxMapXMLReader(void) { }
...
public:
	...
	void __fastcall DoneMapXMLFile(void);
	bool __fastcall IsReadItem(Frxxml::TfrxXMLItem* Item);
public:
	/* TfrxXMLDocument.Create */ inline __fastcall TfrxMapXMLDocument(void) : Frxxml::TfrxXMLDocument() { }
	/* TfrxXMLDocument.Destroy */ inline __fastcall virtual ~TfrxMapXMLDocument(void) { }
...
public:
	...
	void __fastcall SortSum(void);
	__property int Sum[int i] = {read=GetSum, write=SetSum};
public:
	/* TStringList.Create */ inline __fastcall TfrxSumStringList(void)/* overload */ : System::Classes::TStringList() { }
	...
	/* TStringList.Destroy */ inline __fastcall virtual ~TfrxSumStringList(void) { }
...
public:
	__fastcall TfrxClippingRect(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TfrxClippingRect(void) { }
...
extern DELPHI_PACKAGE bool __fastcall IsMercatorLatitude(System::Extended YMin, System::Extended YMax);
