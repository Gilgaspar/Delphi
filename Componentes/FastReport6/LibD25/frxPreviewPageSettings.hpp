...
// (DO NOT EDIT: machine generated header) 'frxPreviewPageSettings.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxPageSettingsForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxPageSettingsForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxPageSettingsForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxPageSettingsForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxPageSettingsForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
