...
// (DO NOT EDIT: machine generated header) 'frxExportDOCXDialog.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxDOCXExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
