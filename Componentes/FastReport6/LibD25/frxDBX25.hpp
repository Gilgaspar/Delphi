...
// (DO NOT EDIT: machine generated header) 'frxDBX25.dpk' rev: 32.00 (Windows)
...
#include <frxDBXEditor.hpp>
#include <frxDBXRTTI.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXDBX25)
using namespace Frxdbx25;
#endif
#pragma pack(pop)
#pragma option pop
