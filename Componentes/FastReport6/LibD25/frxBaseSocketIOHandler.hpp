...
// (DO NOT EDIT: machine generated header) 'frxBaseSocketIOHandler.pas' rev: 32.00 (Windows)
...
public:
	__fastcall virtual TfrxCustomIOHandler(void);
	__fastcall virtual ~TfrxCustomIOHandler(void);
	...
	virtual void __fastcall RunIO(void);
	virtual TfrxSecurityProtocols __fastcall SupportedSecurityProtocol(void);
...
public:
	__fastcall virtual TfrxWinSockIOHandler(void);
	__fastcall virtual ~TfrxWinSockIOHandler(void);
	virtual void __fastcall BindSocket(System::Win::Scktcomp::TCustomWinSocket* Socket);
