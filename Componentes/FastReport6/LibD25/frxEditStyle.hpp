...
// (DO NOT EDIT: machine generated header) 'frxEditStyle.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxStyleEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxStyleEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxStyleEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
