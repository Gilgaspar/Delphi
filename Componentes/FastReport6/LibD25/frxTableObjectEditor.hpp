...
// (DO NOT EDIT: machine generated header) 'frxTableObjectEditor.pas' rev: 32.00 (Windows)
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TfrxTableCellEditor(void) { }
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TfrxTableRowColumnEditor(void) { }
...
public:
	...
	/* TfrxInPlaceEditor.Destroy */ inline __fastcall virtual ~TfrxDragDropRowColumnEditor(void) { }
