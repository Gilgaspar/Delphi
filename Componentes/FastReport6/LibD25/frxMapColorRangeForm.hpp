...
// (DO NOT EDIT: machine generated header) 'frxMapColorRangeForm.pas' rev: 32.00 (Windows)
...
public:
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TColorRangeItem(void) { }
...
public:
	__fastcall TColorRangeCollection(void);
	HIDESBASE TColorRangeItem* __fastcall Add(void);
...
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TColorRangeCollection(void) { }
	
};


class PASCALIMPLEMENTATION TMapColorRangeForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	...
	TColorRangeCollection* __fastcall GetCollection(void);
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TMapColorRangeForm(System::Classes::TComponent* AOwner) : Frxbaseform::TfrxBaseForm(AOwner) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TMapColorRangeForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TMapColorRangeForm(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TMapColorRangeForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
...
protected:
	...
	void __fastcall FillRangeColors(void);
...
public:
	/* TMapRanges.Destroy */ inline __fastcall virtual ~TfrxColorRanges(void) { }
