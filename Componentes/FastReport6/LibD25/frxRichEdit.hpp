...
// (DO NOT EDIT: machine generated header) 'frxRichEdit.pas' rev: 32.00 (Windows)
...
private:
	...
	void __fastcall DoSendSynchMessage(void);
	void __fastcall DoPerformSynchMessage(void);
...
public:
	...
	NativeInt __fastcall SendSynchMessage(unsigned Msg, NativeUInt wPar, NativeInt lPar, bool DoPerform = false);
