...
// (DO NOT EDIT: machine generated header) 'frxBarcodeMaxiCode.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxBarcodeMaxiCode : public Frxbarcode2dbase::TfrxBarcode2DBaseWithOutUnion
{
	typedef Frxbarcode2dbase::TfrxBarcode2DBaseWithOutUnion inherited;
...
public:
	__fastcall virtual TfrxBarcodeMaxiCode(void);
	__fastcall virtual ~TfrxBarcodeMaxiCode(void);
