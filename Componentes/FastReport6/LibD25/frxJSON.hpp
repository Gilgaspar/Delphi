...
// (DO NOT EDIT: machine generated header) 'frxJSON.pas' rev: 32.00 (Windows)
...
public:
	...
	__fastcall virtual ~TfrxJSON(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TfrxJSONArray(void) { }
