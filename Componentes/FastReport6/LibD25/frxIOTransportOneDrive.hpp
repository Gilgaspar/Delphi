...
// (DO NOT EDIT: machine generated header) 'frxIOTransportOneDrive.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxOneDriveIOTransport(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxOneDriveIOTransport(void) : Frxiotransportonedrivebase::TfrxBaseOneDriveIOTransport() { }
