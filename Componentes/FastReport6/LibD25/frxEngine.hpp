...
// (DO NOT EDIT: machine generated header) 'frxEngine.pas' rev: 32.00 (Windows)
...
public:
	__fastcall TfrxShiftEngine(void);
	__fastcall virtual ~TfrxShiftEngine(void);
	void __fastcall Clear(void);
	void __fastcall ClearDestroyQueue(void);
...
private:
	...
	void __fastcall RestoreVBandsObjects(void);
...
public:
	...
	virtual System::Extended __fastcall HeaderHeight(bool AddReprintOnNewPage = false);
