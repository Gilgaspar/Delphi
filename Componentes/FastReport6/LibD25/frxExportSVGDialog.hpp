...
// (DO NOT EDIT: machine generated header) 'frxExportSVGDialog.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxSVGExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
