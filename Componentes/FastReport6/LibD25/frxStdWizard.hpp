...
// (DO NOT EDIT: machine generated header) 'frxStdWizard.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxStdWizardForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxStdWizardForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxStdWizardForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
