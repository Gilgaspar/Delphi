...
// (DO NOT EDIT: machine generated header) 'frxIOTransportFTP.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxBaseTransportDialog.Destroy */ inline __fastcall virtual ~TfrxFTPIOTransportForm(void) { }
	
public:
	/* TfrxBaseForm.Create */ inline __fastcall virtual TfrxFTPIOTransportForm(System::Classes::TComponent* AOwner) : Frxiotransporthelpers::TfrxBaseTransportDialog(AOwner) { }
...
public:
	...
	/* TfrxTransportIndyConnector.Destroy */ inline __fastcall virtual ~TfrxTransportIndyFTPConnector(void) { }
...
private:
	...
	void __fastcall FTPSetHost(void);
	void __fastcall FTPSetProxy(void);
...
protected:
	...
	virtual System::UnicodeString __fastcall FilterSection(void);
...
public:
	...
	__fastcall virtual ~TfrxFTPIOTransport(void);
	...
	virtual Frxbasetransportconnection::TfrxBaseTransportConnectionClass __fastcall GetConnectorInstance(void);
...
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxFTPIOTransport(void) : Frxiotransporthelpers::TfrxInternetIOTransport() { }
