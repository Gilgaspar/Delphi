...
// (DO NOT EDIT: machine generated header) 'frxGauge.pas' rev: 32.00 (Windows)
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TGaugeCoordinateConverter(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TGaugeScaleTicks(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TGaugeMargin(void) { }
...
public:
	...
	virtual bool __fastcall IsPublishedWidth(void);
	virtual bool __fastcall IsPublishedHeight(void);
	virtual bool __fastcall IsPublishedColor(void);
	__property int Width = {read=FWidth, write=SetWidth, nodefault};
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TGaugePointer(void) { }
...
protected:
	...
	void __fastcall UpdateOI(void);
	void __fastcall Repaint(void);
	virtual void __fastcall OneDigit(const System::Types::TPoint &P) = 0 ;
	virtual void __fastcall MultiDigits(void);
	virtual void __fastcall CorrectByMaximum(void) = 0 ;
	virtual void __fastcall CorrectByMinimum(void) = 0 ;
	
public:
	__fastcall TfrxBaseGauge(void);
	__fastcall virtual ~TfrxBaseGauge(void);
	virtual void __fastcall AssignTo(System::Classes::TPersistent* Dest);
	...
	System::Extended __fastcall Radians(void);
...
protected:
	...
	virtual void __fastcall CorrectByMaximum(void);
	virtual void __fastcall CorrectByMinimum(void);
	
public:
	__fastcall TfrxGauge(void);
	virtual void __fastcall AssignTo(System::Classes::TPersistent* Dest);
...
public:
	/* TfrxBaseGauge.Destroy */ inline __fastcall virtual ~TfrxGauge(void) { }
...
public:
	__fastcall TfrxIntervalGauge(void);
	virtual void __fastcall AssignTo(System::Classes::TPersistent* Dest);
	virtual void __fastcall DrawPointer(Vcl::Graphics::TCanvas* Canvas);
	virtual bool __fastcall DoMouseWheel(System::Classes::TShiftState Shift, int WheelDelta, const System::Types::TPoint &MousePos);
...
public:
	/* TfrxBaseGauge.Destroy */ inline __fastcall virtual ~TfrxIntervalGauge(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TSegmentPointer(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TBasePolygonPointer(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TTrianglePointer(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TDiamondPointer(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TPentagonPointer(void) { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TBandPointer(void) { }
