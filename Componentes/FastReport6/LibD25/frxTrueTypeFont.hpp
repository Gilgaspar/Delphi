...
// (DO NOT EDIT: machine generated header) 'frxTrueTypeFont.pas' rev: 32.00 (Windows)
...
private:
	...
	System::WideString __fastcall GetFamilyName(void);
	System::WideString __fastcall GetPostScriptName(void);
