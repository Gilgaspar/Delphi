...
// (DO NOT EDIT: machine generated header) 'frxEditHighlight.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxHighlightEditorForm : public Frxbaseform::TfrxBaseForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxHighlightEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Frxbaseform::TfrxBaseForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxHighlightEditorForm(HWND ParentWindow) : Frxbaseform::TfrxBaseForm(ParentWindow) { }
