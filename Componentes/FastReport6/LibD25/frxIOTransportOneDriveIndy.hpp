...
// (DO NOT EDIT: machine generated header) 'frxIOTransportOneDriveIndy.pas' rev: 32.00 (Windows)
...
protected:
	virtual System::UnicodeString __fastcall GetListFolder(void);
...
public:
	/* TfrxHTTPIOTransport.Destroy */ inline __fastcall virtual ~TfrxOneDriveIOTransportIndy(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxOneDriveIOTransportIndy(void) : Frxiotransportonedrivebase::TfrxBaseOneDriveIOTransport() { }
