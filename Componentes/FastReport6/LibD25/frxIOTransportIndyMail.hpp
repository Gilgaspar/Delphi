...
// (DO NOT EDIT: machine generated header) 'frxIOTransportIndyMail.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TfrxMailIOTransport.Destroy */ inline __fastcall virtual ~TfrxMailIOTransportIndy(void) { }
	
public:
	/* TfrxCustomIOTransport.CreateNoRegister */ inline __fastcall TfrxMailIOTransportIndy(void) : Frxiotransportmail::TfrxMailIOTransport() { }
