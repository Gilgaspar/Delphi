...
// (DO NOT EDIT: machine generated header) 'frxExportODF.pas' rev: 32.00 (Windows)
...
public:
	/* TfrxCustomExportFilter.CreateNoRegister */ inline __fastcall TfrxODFExport(void) : Frxexportbasedialog::TfrxBaseDialogExportFilter() { }
