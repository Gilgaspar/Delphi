...
// (DO NOT EDIT: machine generated header) 'dclfrxDBX25.dpk' rev: 32.00 (Windows)

#ifndef Dclfrxdbx25HPP
#define Dclfrxdbx25HPP
...
#include <frxDBXRTTI.hpp>	// (frxDBX25)
#include <frxDBXEditor.hpp>	// (frxDBX25)
#include <frxDBXComponents.hpp>	// (frxDBX25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxdbx25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxdbx25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDBX25)
using namespace Dclfrxdbx25;
#endif
#pragma pack(pop)
#pragma option pop
