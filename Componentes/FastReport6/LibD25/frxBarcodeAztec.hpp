...
// (DO NOT EDIT: machine generated header) 'frxBarcodeAztec.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxBarcodeAztec : public Frxbarcode2dbase::TfrxBarcode2DBaseWithUnion
{
...
public:
	__fastcall virtual TfrxBarcodeAztec(void);
	__fastcall virtual ~TfrxBarcodeAztec(void);
