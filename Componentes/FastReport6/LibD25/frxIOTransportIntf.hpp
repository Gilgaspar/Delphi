...
// (DO NOT EDIT: machine generated header) 'frxIOTransportIntf.pas' rev: 32.00 (Windows)
...
public:
	...
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TfrxIOTransportItem(void) { }
...
public:
	__fastcall TfrxIOTransportsCollection(void);
...
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TfrxIOTransportsCollection(void) { }
