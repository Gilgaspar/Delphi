...
type
  ...
  TdxBatchUpdateHelper<T{$IFDEF DELPHI102TOKYO}: class{$ENDIF}> = class(TdxBatchUpdateHelper)
  private
  ...
  TdxBatchUpdateHelper<TInfo{$IFDEF DELPHI102TOKYO}: class;{$ELSE},{$ENDIF} TOptions> = class(TdxBatchUpdateHelper)
  private
  ...
  TdxBatchInitHelper<T{$IFDEF DELPHI102TOKYO}: class{$ENDIF}> = class(TdxBatchUpdateHelper<T>)
  strict private type
