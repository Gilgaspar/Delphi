...
resourcestring
  // Clipboard
  sdxSpreadSheetActionCopySelectionCaption = 'Copy';
  sdxSpreadSheetActionCopySelectionHint = 'Copy';
  sdxSpreadSheetActionCutSelectionCaption = 'Cut';
  sdxSpreadSheetActionCutSelectionHint = 'Cut';
  sdxSpreadSheetActionPasteSelectionCaption = 'Paste';
  sdxSpreadSheetActionPasteSelectionHint = 'Paste';
  // Font
  sdxSpreadSheetActionChangeFillColorCaption = 'Fill Color';
  sdxSpreadSheetActionChangeFillColorHint = 'Fill Color';
  sdxSpreadSheetActionChangeFontColorCaption = 'Font Color';
  sdxSpreadSheetActionChangeFontColorHint = 'Font Color';
  sdxSpreadSheetActionChangeFontNameCaption = 'Font Name';
  sdxSpreadSheetActionChangeFontNameHint = 'Font Name';
  sdxSpreadSheetActionChangeFontSizeCaption = 'Font Size';
  sdxSpreadSheetActionChangeFontSizeHint = 'Font Size';
  sdxSpreadSheetActionDecreaseFontSizeCaption = 'Decrease Font Size';
  sdxSpreadSheetActionDecreaseFontSizeHint = 'Decrease Font Size';
  sdxSpreadSheetActionIncreaseFontSizeCaption = 'Increase Font Size';
  sdxSpreadSheetActionIncreaseFontSizeHint = 'Increase Font Size';
  sdxSpreadSheetActionToggleFontBoldCaption = '&Bold';
  sdxSpreadSheetActionToggleFontBoldHint = 'Bold';
  sdxSpreadSheetActionToggleFontItalicCaption = '&Italic';
  sdxSpreadSheetActionToggleFontItalicHint = 'Italic';
  sdxSpreadSheetActionToggleFontStrikeoutCaption = 'Strikeout';
  sdxSpreadSheetActionToggleFontStrikeoutHint = 'Strikeout';
  sdxSpreadSheetActionToggleFontUnderlineCaption = '&Underline';
  sdxSpreadSheetActionToggleFontUnderlineHint = 'Underline';
  // Borders
  sdxSpreadSheetActionBordersAllCaption = 'All Borders';
  sdxSpreadSheetActionBordersAllHint = 'All Borders';
  sdxSpreadSheetActionBordersBottomCaption = 'Bottom Border';
  sdxSpreadSheetActionBordersBottomHint = 'Bottom Border';
  sdxSpreadSheetActionBordersBottomDoubleCaption = 'Bottom Double Border';
  sdxSpreadSheetActionBordersBottomDoubleHint = 'Bottom Double Border';
  sdxSpreadSheetActionBordersBottomThickCaption = 'Thick Bottom Border';
  sdxSpreadSheetActionBordersBottomThickHint = 'Thick Bottom Border';
  sdxSpreadSheetActionBordersLeftCaption = 'Left Border';
  sdxSpreadSheetActionBordersLeftHint = 'Left Border';
  sdxSpreadSheetActionBordersMoreCaption = 'More..';
  sdxSpreadSheetActionBordersMoreHint = 'More..';
  sdxSpreadSheetActionBordersNoneCaption = 'No Border';
  sdxSpreadSheetActionBordersNoneHint = 'No Border';
  sdxSpreadSheetActionBordersOutsideCaption = 'Outside Borders';
  sdxSpreadSheetActionBordersOutsideHint = 'Outside Borders';
  sdxSpreadSheetActionBordersOutsideThickCaption = 'Thick Box Border';
  sdxSpreadSheetActionBordersOutsideThickHint = 'Thick Box Border';
  sdxSpreadSheetActionBordersRightCaption = 'Right Border';
  sdxSpreadSheetActionBordersRightHint = 'Right Border';
  sdxSpreadSheetActionBordersTopAndBottomCaption = 'Top and Bottom Border';
  sdxSpreadSheetActionBordersTopAndBottomHint = 'Top and Bottom Border';
  sdxSpreadSheetActionBordersTopAndBottomDoubleCaption = 'Top and Double Bottom Border';
  sdxSpreadSheetActionBordersTopAndBottomDoubleHint = 'Top and Double Bottom Border';
  sdxSpreadSheetActionBordersTopAndBottomThickCaption = 'Top and Thick Bottom Border';
  sdxSpreadSheetActionBordersTopAndBottomThickHint = 'Top and Thick Bottom Border';
  sdxSpreadSheetActionBordersTopCaption = 'Top Border';
  sdxSpreadSheetActionBordersTopHint = 'Top Border';
  // Alignment
  sdxSpreadSheetActionAlignHorizontalCenterCaption = 'Align Text Center';
  sdxSpreadSheetActionAlignHorizontalCenterHint = 'Align Text Center';
  sdxSpreadSheetActionAlignHorizontalLeftCaption = 'Align Text Left';
  sdxSpreadSheetActionAlignHorizontalLeftHint = 'Align Text Left';
  sdxSpreadSheetActionAlignHorizontalRightCaption = 'Align Text Right';
  sdxSpreadSheetActionAlignHorizontalRightHint = 'Align Text Right';
  sdxSpreadSheetActionAlignVerticalBottomCaption = 'Bottom Align';
  sdxSpreadSheetActionAlignVerticalBottomHint = 'Bottom Align';
  sdxSpreadSheetActionAlignVerticalCenterCaption = 'Middle Align';
  sdxSpreadSheetActionAlignVerticalCenterHint = 'Middle Align';
  sdxSpreadSheetActionAlignVerticalTopCaption = 'Top Align';
  sdxSpreadSheetActionAlignVerticalTopHint = 'Top Align';
  // Text
  sdxSpreadSheetActionTextIndentDecreaseCaption = 'Decrease Indent';
  sdxSpreadSheetActionTextIndentDecreaseHint = 'Decrease Indent';
  sdxSpreadSheetActionTextIndentIncreaseCaption = 'Increase Indent';
  sdxSpreadSheetActionTextIndentIncreaseHint = 'Increase Indent';
  sdxSpreadSheetActionTextWrapCaption = 'Wrap Text';
  sdxSpreadSheetActionTextWrapHint = 'Wrap Text';
  // Merge Cells
  sdxSpreadSheetActionMergeCellsCaption = 'Merge Cells';
  sdxSpreadSheetActionMergeCellsHint = 'Merge Cells';
  sdxSpreadSheetActionMergeCellsAcrossCaption = 'Merge Across';
  sdxSpreadSheetActionMergeCellsAcrossHint = 'Merge Across';
  sdxSpreadSheetActionMergeCellsAndCenterCaption = 'Merge and Center';
  sdxSpreadSheetActionMergeCellsAndCenterHint = 'Merge and Center';
  sdxSpreadSheetActionUnmergeCellsCaption = 'Unmerge Cells';
  sdxSpreadSheetActionUnmergeCellsHint = 'Unmerge Cells';
  // Insert Cells
  sdxSpreadSheetActionInsertColumnsCaption = 'Insert Sheet Columns';
  sdxSpreadSheetActionInsertColumnsHint = 'Insert Sheet Columns';
  sdxSpreadSheetActionInsertRowsCaption = 'Insert Sheet Rows';
  sdxSpreadSheetActionInsertRowsHint = 'Insert Sheet Rows';
  sdxSpreadSheetActionInsertSheetCaption = 'Insert Sheet';
  sdxSpreadSheetActionInsertSheetHint = 'Insert Sheet';
  // Delete Cells
  sdxSpreadSheetActionDeleteColumnsCaption = 'Delete Sheet Columns';
  sdxSpreadSheetActionDeleteColumnsHint = 'Delete Sheet Columns';
  sdxSpreadSheetActionDeleteRowsCaption = 'Delete Sheet Rows';
  sdxSpreadSheetActionDeleteRowsHint = 'Delete Sheet Rows';
  sdxSpreadSheetActionDeleteSheetCaption = 'Delete Sheet';
  sdxSpreadSheetActionDeleteSheetHint = 'Delete Sheet';
  // Format Cells
  sdxSpreadSheetActionAutoFitColumnWidthCaption = 'AutoFit Column Width';
  sdxSpreadSheetActionAutoFitColumnWidthHint = 'AutoFit Column Width';
  sdxSpreadSheetActionAutoFitRowHeightCaption = 'AutoFit Row Height';
  sdxSpreadSheetActionAutoFitRowHeightHint = 'AutoFit Row Height';
  sdxSpreadSheetActionHideColumnsCaption = 'Hide Columns';
  sdxSpreadSheetActionHideColumnsHint = 'Hide Columns';
  sdxSpreadSheetActionHideRowsCaption = 'Hide Rows';
  sdxSpreadSheetActionHideRowsHint = 'Hide Rows';
  sdxSpreadSheetActionHideSheetCaption = 'Hide Sheet';
  sdxSpreadSheetActionHideSheetHint = 'Hide Sheet';
  sdxSpreadSheetActionUnhideColumnsCaption = 'Unhide Columns';
  sdxSpreadSheetActionUnhideColumnsHint = 'Unhide Columns';
  sdxSpreadSheetActionUnhideRowsCaption = 'Unhide Rows';
  sdxSpreadSheetActionUnhideRowsHint = 'Unhide Rows';
  sdxSpreadSheetActionUnhideSheetCaption = 'Unhide Sheet';
  sdxSpreadSheetActionUnhideSheetHint = 'Unhide Sheet';
  // Clear
  sdxSpreadSheetActionClearAllCaption = 'Clear All';
  sdxSpreadSheetActionClearAllHint = 'Clear All';
  sdxSpreadSheetActionClearContentsCaption = 'Clear Contents';
  sdxSpreadSheetActionClearContentsHint = 'Clear Contents';
  sdxSpreadSheetActionClearFormatsCaption = 'Clear Formats';
  sdxSpreadSheetActionClearFormatsHint = 'Clear Formats';
  // Sort Filter
  sdxSpreadSheetActionSortAscendingCaption = 'Sort A to Z';
  sdxSpreadSheetActionSortAscendingHint = 'Sort A to Z';
  sdxSpreadSheetActionSortDescendingCaption = 'Sort Z to A';
  sdxSpreadSheetActionSortDescendingHint = 'Sort Z to A';
  // Grouping
  sdxSpreadSheetActionGroupColumnsCaption = 'Group Columns';
  sdxSpreadSheetActionGroupColumnsHint = 'Group Columns';
  sdxSpreadSheetActionGroupRowsCaption = 'Group Rows';
  sdxSpreadSheetActionGroupRowsHint = 'Group Rows';
  sdxSpreadSheetActionUngroupColumnsCaption = 'Ungroup Columns';
  sdxSpreadSheetActionUngroupColumnsHint = 'Ungroup Columns';
  sdxSpreadSheetActionUngroupRowsCaption = 'Ungroup Rows';
  sdxSpreadSheetActionUngroupRowsHint = 'Ungroup Rows';
  // Comments
  sdxSpreadSheetActionDeleteCommentsCaption = 'Delete Comments';
  sdxSpreadSheetActionDeleteCommentsHint = 'Delete Comments';
  sdxSpreadSheetActionEditCommentCaption = 'Edit Comment';
  sdxSpreadSheetActionEditCommentHint = 'Edit Comment';
  sdxSpreadSheetActionNewCommentCaption = 'New Comment';
  sdxSpreadSheetActionNewCommentHint = 'New Comment';
  sdxSpreadSheetActionNextCommentCaption = 'Next Comment';
  sdxSpreadSheetActionNextCommentHint = 'Next Comment';
  sdxSpreadSheetActionPreviousCommentCaption = 'Previous Comment';
  sdxSpreadSheetActionPreviousCommentHint = 'Previous Comment';
  sdxSpreadSheetActionShowHideCommentsCaption = 'Show / Hide Comments';
  sdxSpreadSheetActionShowHideCommentsHint = 'Show / Hide Comments';
  // Zoom
  sdxSpreadSheetActionZoomDefaultCaption = '100%';
  sdxSpreadSheetActionZoomDefaultHint = '100%';
  sdxSpreadSheetActionZoomInCaption = 'Zoom In';
  sdxSpreadSheetActionZoomInHint = 'Zoom In';
  sdxSpreadSheetActionZoomOutCaption = 'Zoom Out';
  sdxSpreadSheetActionZoomOutHint = 'Zoom Out';
  // Freeze
  sdxSpreadSheetActionFreezeFirstColumnCaption = 'Freeze First Column';
  sdxSpreadSheetActionFreezeFirstColumnHint = 'Freeze First Column';
  sdxSpreadSheetActionFreezePanesCaption = 'Freeze Panes';
  sdxSpreadSheetActionFreezePanesHint = 'Freeze Panes';
  sdxSpreadSheetActionFreezeTopRowCaption = 'Freeze Top Row';
  sdxSpreadSheetActionFreezeTopRowHint = 'Freeze Top Row';
  sdxSpreadSheetActionUnfreezePanesCaption = 'Unfreeze Panes';
  sdxSpreadSheetActionUnfreezePanesHint = 'Unfreeze Panes';
  // Print
  sdxSpreadSheetActionPageSetupCaption = 'Page Setup';
  sdxSpreadSheetActionPageSetupHint = 'Page Setup';
  sdxSpreadSheetActionPrintCaption = '&Print';
  sdxSpreadSheetActionPrintHint = 'Print';
  sdxSpreadSheetActionPrintPreviewCaption = 'Print Pre&view';
  sdxSpreadSheetActionPrintPreviewHint = 'Print Preview';
  // History
  sdxSpreadSheetActionRedoCaption = 'Redo';
  sdxSpreadSheetActionRedoHint = 'Redo';
  sdxSpreadSheetActionUndoCaption = 'Undo';
  sdxSpreadSheetActionUndoHint = 'Undo';
  // Common
  sdxSpreadSheetActionNewDocumentCaption = '&New';
  sdxSpreadSheetActionNewDocumentHint = 'New';
  sdxSpreadSheetActionOpenDocumentCaption = '&Open';
  sdxSpreadSheetActionOpenDocumentHint = 'Open';
  sdxSpreadSheetActionSaveDocumentAsCaption = '&Save As';
  sdxSpreadSheetActionSaveDocumentAsHint = 'Save As';
  // Find And Replace
  sdxSpreadSheetActionFindAndReplaceCaption = 'Find && Replace';
  sdxSpreadSheetActionFindAndReplaceHint = 'Find & Replace';
  // PageSetup
