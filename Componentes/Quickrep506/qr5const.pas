...
resourcestring
  ...
  SqrZoomToFit = 'Zoom para página';
  SqrZoom100 = '100% zoom';
  SqrZoomToWidth = 'Zoom para largura';
  SqrFirstPage = 'Primeira página';
  SqrPrevPage = 'Página anterior';
  SqrNextPage = 'Próxima página';
  SqrLastPage = 'Última página';
  SqrPrintReport = 'Imprimir relatório';
  SqrPrinterSetup = 'Configurar impressora';
  SqrSaveReport = 'Salvar relatório';
  SqrLoadReport = 'Carregar relatório';
  SqrPage = 'Página';
  SqrOf = 'de';
  ...
  SqrPageNum = 'Page#';
  SqrReportTitle = 'Titulo do relatório';
  SqrDetailCount = 'Detelhas';
  ...
  SqrCopyright = 'Copyright 2013 QBS Software';
  SqrZoomIn = 'Zoo&m in';
  ...
  SqrXMLDocumentForWeb = 'XML não pode ser exibido';
  sqrSearchResults = 'Resultados';
  sqrThumbNails = 'Miniaturas';
  sqrSearchText = 'Texto';
  sqrFindCaption = 'Buscar por texto';
  sqrClosePreview = 'Fechar preview';
  sqrPageSelect = 'Indique a página';
  sqrGoPage = 'Número da página';
  sqrMatchCase = 'Resultados';
  sqrSearchButtonCaption = 'Buscar';
  sqrSearchDialogCaption = 'Buscar texto';
  sqrPreviewWindowCaption = 'Visualização : ';
  sqrExitButtonCaption = '&Fechar';
  sqrSearchNoResult = 'Texto não encontrado';
  // do not translate
  sqrPDFExt = '.pdf';
  sqrHTMLExt = '.html';
  sqrRTFExt = '.rtf';
  ...
  sqrQRPExt = '.qrp';
  sqrXMLExt = '.xml';
  sqrCancelButtonHint = 'Cancelar';
  sqrCopyButtonHint = 'Copiar para área de transferência';
  sqrHTMLFirstPage = 'Primeira página';
  sqrHTMLLastPage = 'Ultima página';
  sqrHTMLPrevPage = 'Página anterior';
  sqrHTMLNextPage = 'Próxima página';
  sqrSetZoomHint = 'Definir zoom';
  sqrExportProgress = 'ProgresSo da exportação';
