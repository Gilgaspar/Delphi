...
uses
  ...
  ComCtrls, qrexport, QRPrntr, QuickRpt, QR5Const, QRCtrls, grimgctrl, pdfconst;
...
begin
  ...
  try
    ...
    if (GControl is TQRPDFShape) then begin
      ...
      PDFItem.Width:=PShCont.Width*PointsPerPixelX*BGHFactor;
    ...
    begin
      ...
      PDFItem.Width:=ShCont.Width*PointsPerPixelX*BGHFactor;
