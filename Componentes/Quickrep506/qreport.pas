...
uses
  Classes, QuickRpt, DesignIntf, DesignEditors,{ ExptIntf, }
  {$ifdef QRPP}
...
uses
  sysutils, windows, typinfo, controls, stdctrls, forms, qrprntr, QRGraphcon,QRMetriclab,
  db, QRCtrls, QRExtra, Dialogs, QRAbout, QRComped, QRExpbld, QR5Const,QRQRBarcode,
  QRExport, QREnvEd, QRExpr,GrImgctrl, QRXMLSFilt, QRDMBarcode, {QRJpegImage,}
  QRPDFFilt, QRWebfilt, QRAbsDatas, qrframelines, QRXLSXFilt, QRNewXLSXFilt;
...
procedure Register;
begin
  RegisterComponents(SqrPaletteQReport,[TQuickRep, TQRPreviewController, TQuickAbstractRep, TQRSubDetail, TQRLoopBand, TQRStringsBand,
    TQRBand, TQRWildband, TQRChildBand, TQRGroup, TQRLabel, TQRMetricLabel,TQRDBText, TQRExpr, TQRSysData, TQRMemo, TQRExprMemo,
    TQRRichText, TQRDBRichText, TQRShape, TQRGraphicCanvas, TQRImage, TQRDBImage, TQRCompositeReport,TQRXMLSSFilter,TQRXLSXFilter, TQRPreview,
    TQRDMBarcode, TQRDbDMBarcode, TQRQRBarcode, TQRQRDBBarcode, TQRTextFilter, TQRCSVFilter, TQRPDFFilter, TQRXMLSFilter, TQRHTMLFilter, TQRExcelFilter,
    TQRRTFFilter, TQRWMFFilter{, TQREditor}, TQRGrImage{, TQRDBJPGImage}, TQrGrDBImage, TQRPDFShape, TQRFrameLine, TQRAbsTable, TQRHTMLLabel, TQRHRule
    {$ifdef QRPP}
    ,TQRPQuickrep,
    TQRPBand,
    TQRPChildBand,
  ...
  RegisterPropertyEditor(TypeInfo(string), TQRQRDbBarcode, 'DataField', TQRDataFieldProperty);
  RegisterPropertyEditor(TypeInfo(string), TQRDbDMBarcode, 'DataField', TQRDataFieldProperty);
  ...
  RegisterCustomModule(TCustomQuickRep,TCustomModule);
end;
