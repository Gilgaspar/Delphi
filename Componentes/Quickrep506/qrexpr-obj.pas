{ :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  :: QuickReport 5.04 for Delphi and C++Builder              ::
  ::                                                         ::
  ...
  ::                                                         ::
  :: This version has the leaky result object                ::
  ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: }
...
type
  ...
  TQREvResult_old = record
   ...
   TQREvResult = class(TObject)
   public
      Kind : TQREvResultType;
      intResult : longint;
      dblResult : double;
      strResult : string;
      booResult : boolean;
  ...
  public
    EvResult : TQREvResult; // unitialised object property
  end;
...
begin
  repeat
    ...
    begin
      aResult := TQREvResultClass.Create;// ********** problem
...
begin
  ...
  begin
    ...
    begin
      ...
      result := EvalEnvironment(strVariable);
  end else
    result := EvalEnvironment(strVariable);
end;
...
begin
  ...
  begin
    ...
    Result := Res2; // last thing on stack. Res1 is a leak right now.
  end
  else
...
begin
  ...
  begin
    ...
    if (Length(Argument(0).StrResult) > 0) and CharInSet(Argument(0).StrResult[1], LeadBytes) then
...
begin
  ...
  begin
    ...
    begin
      if SumResult=nil then
             SumResult := TQREvResult.Create;
