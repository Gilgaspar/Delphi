...
// (DO NOT EDIT: machine generated header) 'QRAbsDatas.pas' rev: 30.00 (Windows)
...
protected:
	...
	inline void __fastcall  InternalGotoBookmark(System::TArray__1<System::Byte> Bookmark){ Data::Db::TDataSet::InternalGotoBookmark(Bookmark); }
	...
	inline void __fastcall  SetFieldData(Data::Db::TField* Field, System::TArray__1<System::Byte> Buffer){ Data::Db::TDataSet::SetFieldData(Field, Buffer); }
...
public:
	inline bool __fastcall  GetFieldData(Data::Db::TField* Field, System::TArray__1<System::Byte> &Buffer){ return Data::Db::TDataSet::GetFieldData(Field, Buffer); }
