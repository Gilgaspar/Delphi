...
//-- type declarations -------------------------------------------------------
_DECLARE_METACLASS(System::TMetaClass, TQRNewComponentClass);
...
_DECLARE_METACLASS(System::TMetaClass, TQRPrintableClass);

_DECLARE_METACLASS(System::TMetaClass, TQRPrintableEditorClass);
