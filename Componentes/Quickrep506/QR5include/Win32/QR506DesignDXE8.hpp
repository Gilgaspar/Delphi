...
// (DO NOT EDIT: machine generated header) 'QR506DesignDXE8.dpk' rev: 29.00 (Windows)

#ifndef Qr506designdxe8HPP
#define Qr506designdxe8HPP
...
#include <QRExpr.hpp>	// (QR506RunDXE8)
#include <Vcl.Grids.hpp>	// (vcl)
#include <QRExport.hpp>	// (QR506RunDXE8)
#include <Vcl.Imaging.jpeg.hpp>	// (vclimg)
#include <QRWebFilt.hpp>	// (QR506RunDXE8)
#include <pdfconst.hpp>	// (QR506RunDXE8)
#include <QRPDFFilt.hpp>	// (QR506RunDXE8)
#include <QRXLSXFilt.hpp>	// (QR506RunDXE8)
#include <System.Zip.hpp>	// (rtl)
#include <QRNewXLSXFiltProcs.hpp>	// (QR506RunDXE8)
#include <QRNewXLSXFilt.hpp>	// (QR506RunDXE8)
#include <QRCtrls.hpp>	// (QR506RunDXE8)
#include <QRExtra.hpp>	// (QR506RunDXE8)
#include <QRPrev.hpp>	// (QR506RunDXE8)
#include <Vcl.OleServer.hpp>	// (vcl)
#include <QRXMLSFilt.hpp>	// (QR506RunDXE8)
#include <QRPrntr.hpp>	// (QR506RunDXE8)
#include <Vcl.OleCtnrs.hpp>	// (vcl)
#include <QRPrnSu.hpp>	// (QR506RunDXE8)
#include <QuickRpt.hpp>	// (QR506RunDXE8)
...
#include <qrpexpr.hpp>	// (QR506RunDXE8)
#include <ECC200ReedSolomon.hpp>	// (QR506RunDXE8)
#include <ECC200procs.hpp>	// (QR506RunDXE8)

//-- user supplied -----------------------------------------------------------

namespace Qr506designdxe8
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Qr506designdxe8 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_QR506DESIGNDXE8)
using namespace Qr506designdxe8;
#endif
#pragma pack(pop)
#pragma option pop
