...
{ TQRPrinterSetupDialog }
  ...
  private
    FPrinter : TPrinter;
  protected
    Device, Driver, Port: array[0..1024] of char; // TF
...
{$endif}
        ...
        CreationControl.FDefWndProc := Pointer(SetWindowLongPtr(Wnd, GWLP_WNDPROC,
            LONG_PTR(CreationControl.FObjectInstance)));
