...
{*************************************************************************}
  ...
  published
    ...
    property LeftMethod: TDistMethod read FLeftMethod write SetLeftMethod default dmMargin;
    property RightMethod: TDistMethod read FRightMethod write SetRightMethod default dmMargin;
    property TopMethod: TDistMethod read FTopMethod write SetTopMethod default dmSpecial;
    property BottomMethod: TDistMethod read FBottomMethod write SetBottomMethod default dmMargin;
    property HeightMethod: THeightMethod read FHeightMethod write FHeightMethod default hmLines;
