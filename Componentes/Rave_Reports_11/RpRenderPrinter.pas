...
begin
  ...
  If Converter.ReportHeader.DMPaperSize <> DMPAPER_USER then begin
    RpDev.SetPaperSize(Converter.ReportHeader.DMPaperSize,0,0);
  end else begin
    RpDev.SetPaperSize(0,Converter.ReportHeader.DMPaperWidth,
     Converter.ReportHeader.DMPaperLength);
  end; { else }
...
begin
  RpDev.Orientation := Converter.ReportHeader.Orientation;
  if RpDev.IgnoreNDRBin then begin
    RpDev.Bin := RpDev.SetupBin;
  end else begin
...
begin { SelectBin }
  ...
  Converter.ReportHeader.Bin := RpDev.DevMode.dmDefaultSource;
end;  { SelectBin }
