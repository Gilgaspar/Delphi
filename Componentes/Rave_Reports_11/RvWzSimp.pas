...
type
  ...
  private
    ...
    procedure SetFontChangeButtonWidth;
...
begin
  ...
  RptTitleEdit.Text := Trans('Simple Table Report');
end;
...
procedure TRvWzSimpleForm.SetFontChangeButtonWidth;
begin
  TitleFontBtn.Width := Canvas.TextWidth(TitleFontBtn.Caption) + 20;
  TitleFontBtn.Left := Panel6.Width - TitleFontBtn.Width - 11;
  CaptionFontBtn.Width := TitleFontBtn.Width;
  CaptionFontBtn.Left := TitleFontBtn.Left;
  BodyFontBtn.Width := TitleFontBtn.Width;
  BodyFontBtn.Left := TitleFontBtn.Left;
end;
