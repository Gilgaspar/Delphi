...
const
  RaveVersion = 110000; { 11.0000 }
  RegRoot = {Trans-}'\Software\Nevrona Designs\Rave110\';
  RaveMajorVersion = 770;
  RaveMinorVersion = 2;
...
type
  ...
  TRaveAnchor = type byte; //!!!TODO!!! Change back to typed type
  ...
  TRaveFloat = double;
  TRaveUnits = type TRaveFloat; //!!!TODO!!! Change back to typed type
  TRaveFieldName = type string; //!!!TODO!!! Change back to typed type
  TRaveMemoString = type string; //!!!TODO!!! Change back to typed type
  ...
  TRaveBin = type integer; //!!!TODO!!! Change back to typed type
  TRaveBinName = record
    Name: string;
    RaveBin: TRaveBin;
  end; { TRaveBinName }
...
var
  RaveTitle: string = {Trans-}'Rave Reports 11.0 BEX'; { Title to be displayed in Visual Designer }
