...
uses
  SysUtils, Windows, Messages, Classes, Controls, TypInfo,
  Graphics, Dialogs, Forms, DB, {$IFNDEF LevelXE7}{$IFNDEF CPUX64}DBTables,{$ENDIF}{$ENDIF} RpDefine, RpBase, RpTable;
