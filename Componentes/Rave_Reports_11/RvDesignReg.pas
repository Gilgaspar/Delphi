...
{TransOff}
  ...
  RegisterRaveProperties(TRaveLine,
    ...
    {Developer}    '',
    {Hidden}       'NESW');
  RegisterRavePropertyAlias(TRaveLine, 'ForeColor', 'Color');
  ...
  RegisterRaveProperties(TRaveSurface,
    ...
    {Developer}    '',
    {Hidden}       '');
  RegisterRavePropertyAlias(TRaveSurface, 'ForeColor', 'BorderColor');
  RegisterRavePropertyAlias(TRaveSurface, 'LineStyle', 'BorderStyle');
  RegisterRavePropertyAlias(TRaveSurface, 'LineWidth', 'BorderWidth');
  RegisterRavePropertyAlias(TRaveSurface, 'LineWidthType', 'BorderWidthType');
  RegisterRavePropertyAlias(TRaveSurface, 'BackColor', 'FillColor');
